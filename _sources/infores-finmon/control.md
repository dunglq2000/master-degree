...
Đồng thời, bất kỳ InfoObject nào từ tín hiệu vật lý đến dữ liệu trong môi trường điện toán và văn bản trong xã hội đều có bản chất ngữ nghĩa. Ngữ nghĩa của tín hiệu được xác định bởi các quy luật tự nhiên, ngữ nghĩa của dữ liệu - bởi cấu trúc (các mạch logic-vật lý của cơ sở dữ liệu), ngữ nghĩa của văn bản - bởi hệ thống khái niệm phân loại của miền. Ngữ nghĩa (chính xác hơn là ý nghĩa) của InfoOb là hình ảnh khái niệm về nội dung của nó (cũng là InfoOb), được xác định liên quan đến một số khía cạnh SbA. Đây là giá trị thu được bằng cách ánh xạ nội dung (giá trị InfoObject) vào trường ngữ nghĩa (đặc tả, cụ thể là ở dạng bản thể luận SbA hoặc một khía cạnh riêng biệt).
...
2. Thông tin có tính hai mặt trạng thái. Đối tượng thông tin trước khi tương tác là một sự hình thành không thể tách rời nào đó; trong quá trình tương tác, nó là một hình thức vĩ mô, một cấu trúc của “lượng tử”, cũng có thể là các yếu tố cấu thành hoặc sự kết hợp của các đối tượng khác, hiện có hoặc giả định. Hoặc, tương tự với vật lý, thông tin trong quá trình lưu trữ và truyền tải thể hiện các thuộc tính của một đối tượng vĩ mô và trong các quá trình tương tác thông tin với các đối tượng thông tin khác - thuộc tính sóng.
...
5. Tính kết nối của thông tin (trong trường hợp thông tin tài liệu thì nói rằng nó có tính chất ngữ nghĩa).
...
6. Hiệu quả của thông tin. Hơn nữa, tương tác thông tin được đặc trưng bởi các tính năng sau:
...
Tính liên tục của thông tin, như một hình thức tích lũy, có liên quan trực tiếp đến tính liên tục trong sự phát triển của khoa học, công nghệ, sản xuất và các lĩnh vực hoạt động khác của con người. Tính chất liên tục được thể hiện ở các khía cạnh lịch sử, ngành và liên ngành.
...
Trong một số nguồn, các thuộc tính của thông tin bao gồm các biểu hiện được xác định không phải bởi các thuộc tính của thông tin mà bởi môi trường, chẳng hạn như sau:
...
- **симуляционное** — такое информирование, при котором множество образов содержит больше информации, чем во множестве оригиналов.
...
- **конфузионное** — информирование, образованное из симуляционного и диссимуляционного информирований.
...
## 6.	Обобщенная схема информационного обслуживания.
...
Trong trường hợp tổng quát, sơ đồ tương tác giữa người tiêu dùng và nhà cung cấp thông tin (xem Hình 1.1) có thể được chuyển thành sơ đồ dịch vụ thông tin được trình bày trong Hình. 1.2.
...
Ở đây, các nguồn thông tin, cùng với cách trình bày tài liệu của tác giả ban đầu, phần lớn được đặc trưng bởi tính hệ thống hóa cao (hồ sơ chuyên đề của các nguồn và bản chất cốt lõi của các chủ đề theo chủ đề), cũng như sự hiện diện gần như bắt buộc của siêu thông tin. : tìm kiếm hình ảnh tài liệu và hệ thống thông tin thứ cấp - rubricator và thesauri, đảm bảo tính thống nhất trong cách trình bày và tổ chức tiếp cận các nguồn tài liệu.
...
Các đối tượng hoạt động của chính tìm kiếm máy là hình ảnh tìm kiếm của tài liệu (SID) và hình ảnh tìm kiếm của yêu cầu (SRE), sự tương ứng được thiết lập bởi cơ chế tìm kiếm AIPS ở cấp độ chính thức. Việc thiết lập sự tương ứng thực sự của nội dung tài liệu với nhu cầu thông tin liên quan đến mối tương quan ở cấp độ ngữ nghĩa: người dùng sẽ xây dựng lại nội dung có thể có theo các khái niệm cơ bản được trình bày trong AML và sau đó tương quan hình ảnh thu được với nhu cầu thực sự. Đồng thời, mức độ phù hợp của hình ảnh với nội dung thực tế của tài liệu không chỉ được xác định bởi chất lượng lập chỉ mục mà còn bởi trình độ hiểu biết của đối tượng về các phương tiện phản ánh - sơ đồ khái niệm của lĩnh vực chủ đề và khả năng của ngôn ngữ truy xuất thông tin.
...
Liên quan đến một thông báo thông tin cụ thể, chúng ta có thể nói rằng mỗi phần tử ID thực hiện các biến đổi ngữ nghĩa hoặc định dạng (nhưng không tổng hợp) của thông báo này, đưa ra sự không chắc chắn này hoặc một sự không chắc chắn khác. Ví dụ: sự không chắc chắn được tạo ra bởi các biến đổi cấu trúc và định dạng (lựa chọn các tính năng tìm kiếm chính thức, hình thức trình bày và phổ biến thông điệp, v.v.) có thể dẫn đến không tìm thấy và không chắc chắn về ngữ nghĩa (điều chỉnh nội dung theo yêu cầu của ấn phẩm, chẳng hạn) có thể dẫn tới việc không được công nhận.
...
Do đó, hoạt động truy xuất thông tin không nên là một hành động, nói chung, là một chuỗi các hành động lặp đi lặp lại không chỉ cung cấp việc nhận thông tin hữu ích làm thay đổi trạng thái của người tiêu dùng (chính xác hơn là về mặt giải quyết vấn đề của anh ta). OD), mà còn cả dữ liệu cho phép khách quan (và tốt nhất là định lượng) đánh giá các thuộc tính thực dụng của thông tin được tìm thấy bằng AIPS - tính đầy đủ, độ tin cậy, mức độ liên quan, v.v.
...
Điều này nhấn mạnh vai trò tích cực của người tiêu dùng trong việc “nhận” thông tin: kết nối (loại 5-1 trong Hình 1.1) để truyền thông tin được khởi tạo không phải bởi hệ thống, như theo hướng mũi tên, mà, trên ngược lại, bằng quyền truy cập của người tiêu dùng thông qua AIPS vào tài nguyên do anh ta chọn và chính anh ta là người phải đánh giá kết quả của sự tương tác và đưa ra quyết định về việc hoàn thành nó hay chọn một tài nguyên khác.
...
Cũng cần lưu ý rằng một tính năng quan trọng nhưng ít được chú ý là nhận thức về cơ bản khác nhau của người dùng và hệ thống đối tượng thông tin cơ bản - tài liệu và truy vấn. Một người xem chúng như những vật mang thông tin (nói chung, ý nghĩa của chúng có thể khác nhau tùy theo quan điểm của người dùng), đồng thời làm nổi bật và chuyển đổi các đoạn riêng lẻ (thường không trùng với một câu văn bản, đoạn văn, v.v.) vì vậy rằng trong ý thức những hình ảnh và khái niệm ổn định đã xuất hiện. Đối với AIPS, các đối tượng tương tự là tập hợp dữ liệu từ đó các thuật ngữ (từ, cụm từ, mã, ngày tháng, v.v.) được chọn một cách máy móc (không trích xuất hoặc chuyển đổi ý nghĩa), được so sánh với các thuật ngữ truy vấn.
...
Hơn nữa, một người coi một tài liệu là hữu ích (phù hợp nhất với yêu cầu) nếu nó chứa thông tin mới, chưa biết trước đó, tức là. đưa ra hoặc cho phép người ta tìm câu trả lời cho một câu hỏi nhất định (“như thế nào?”, “cái gì?”) khi giải quyết một vấn đề thực tế. Hệ thống coi tài liệu chứa số lượng thuật ngữ lớn nhất trong truy vấn là tài liệu phù hợp nhất với yêu cầu. Tức là rất có thể người dùng sẽ được cung cấp trước những tài liệu quen thuộc nhất, có thể do chính họ viết ra, khó có thể mang lại cho họ những kiến ​​thức mới.
...
Một điểm quan trọng khác liên quan đến khái niệm cấu trúc tài liệu. Đối với một người, khái niệm này trong hầu hết các trường hợp (ít nhất là đối với tài liệu văn bản) có liên quan đến tính dễ nhận thức, tức là. mô tả cấu trúc thực tế không được sử dụng, vì các trường thông tin riêng lẻ của tài liệu thường được nhận dạng bằng các dấu hiệu gián tiếp (đoán). Đối với các hệ thống tự động, khái niệm cấu trúc là không thể thiếu và mang tính quyết định ban đầu. Hơn nữa, mỗi thành phần cấu trúc (chi tiết) của tài liệu phải có định dạng, tên riêng và có thể có phương pháp xử lý riêng. Ví dụ: cách viết ngày tháng hoặc các quy tắc khác nhau để đánh dấu các thuật ngữ trong các trường văn bản khác nhau (trong nhiều hệ thống, ký tự khoảng trắng trong trường từ khóa không được coi là dấu phân cách, do đó cho phép làm nổi bật các cụm từ).
...
Trong trường hợp có hai vòng điều khiển được kết nối thông tin (không có chuỗi mã giữa chúng), sơ đồ như vậy sẽ thể hiện quá trình siêu thông tin.

---

Принципиальная схема информационных и кодовых цепей для случая метаинформи-рования приведена на рис. 1.22.

Sơ đồ thông tin và chuỗi mã cho trường hợp siêu thông tin được hiển thị trong Hình 2. 1,22.
...
Ví dụ: hai đồng hồ bị trễ cùng một lúc sẽ cung cấp thông tin nhất quán, mặc dù sai.
...
Nếu lời khai của hai nhân chứng về cùng một sự kiện giống nhau thì hoặc là cả hai đều nói sự thật hoặc cả hai lời khai đều sai như nhau. Một lời nói dối không thể được phát hiện bằng cách so sánh với một lời nói dối tương tự khác. Tội phạm biết điều này và do đó cố gắng nói với những đồng phạm của họ khi được tự do khỏi nhà tù những gì họ nên nói nếu bị giam giữ. Cơ quan điều tra cũng biết về việc này và do đó cố gắng ngăn chặn việc chuyển giao những thông tin đó.
...
Tính hữu ích của thông tin chứa trong các liên kết hình ảnh của các vòng điều khiển nhất định là chúng mô tả các kết nối giữa các bản gốc trong các vòng điều khiển này. Nếu để điều khiển, cần phải biết các kết nối giữa các thông tin này thì thông tin sau sẽ có đặc tính liên kết các bản gốc cho vòng điều khiển bên ngoài, trong đó các bản gốc này phải được chuyển đổi thành hình ảnh thích hợp để thông tin chứa trong liên kết này hình ảnh mô tả kết nối giữa thông tin thu được từ các vòng điều khiển riêng lẻ.
...
Trong quá trình kiểm soát meta, do sự khác biệt về siêu hình ảnh, siêu thông tin hoặc thông tin về siêu bản gốc, thu được và vì siêu bản gốc là tập hợp các hình ảnh cung cấp khả năng siêu thông tin, nên sau đó , do đó, siêu thông tin là thông tin về thông tin.
...
Những quy định này có thể được minh họa bằng ví dụ kỹ thuật sau. Giả sử rằng để đo giá trị của một đại lượng vật lý nhất định, tức là để so sánh với đơn vị đo người ta dùng dụng cụ đo chuẩn. Số chỉ của thiết bị đo được so sánh với đơn vị đo, thu được thông tin cho biết kết quả đo đại lượng lớn hơn đơn vị đo bao nhiêu lần. Tuy nhiên, điều này không dẫn đến thông tin thu được giống với thông tin cho biết đại lượng đo được lớn hơn đơn vị đo bao nhiêu lần, vì người ta không biết liệu thiết bị đo có thực sự đưa ra số đọc chính xác hay không.
...
Để đảm bảo rằng số đọc của thiết bị là chính xác, phép đo bổ sung được thực hiện bằng thiết bị điều khiển. Nếu phép đo sử dụng thiết bị điều khiển cho kết quả tương tự như phép đo sử dụng thiết bị tiêu chuẩn.
...
Tuy nhiên, sự giống nhau của các kết quả đo chỉ có thể được đánh giá trên cơ sở so sánh số đọc của chúng và sự so sánh như vậy không thể chỉ là so sánh số đọc của cả hai thiết bị khi đo một giá trị nhất định của một đại lượng. Như sau ở trên, cũng cần phải so sánh số đọc của thiết bị cho đơn vị đo. Do đó, thông tin thu được bằng cách sử dụng thiết bị đo tiêu chuẩn (số lần đọc của thiết bị tiêu chuẩn cho giá trị đo được lớn hơn số đọc của thiết bị đo cho đơn vị đo) được so sánh với thông tin thu được bằng thiết bị điều khiển (có bao nhiêu lần). số lần số đọc của thiết bị điều khiển đối với giá trị đo được lớn hơn số chỉ của nó đối với đơn vị đo).

---

Подобную роль в практике измерений (информировании) играет помещенное на из-мерительном приборе клеймо, которым метрологическое учреждение удостоверяет, что работа прибора соответствует установленным требованиям (метаинформирование).

Vai trò tương tự trong thực hành đo lường (cung cấp thông tin) được thực hiện bằng tem đặt trên thiết bị đo, với con tem này cơ quan đo lường chứng nhận rằng hoạt động của thiết bị đáp ứng các yêu cầu đã thiết lập (siêu thông tin).
...
Việc thay thế thông tin bằng siêu thông tin nhằm che giấu sự thật cũng được sử dụng trong quảng cáo, khi thay vì báo cáo dữ liệu thực tế về sản phẩm (thông tin) được quảng cáo thì người ta lại nói rằng nó rất tốt, tốt nhất, v.v., tức là ki của sản phẩm so với các sản phẩm khác cùng loại (siêu thông tin).
...
Tương tự, trong lĩnh vực tuyên truyền, những lời buộc tội của các đối thủ chính trị thường bị coi là dối trá, giả mạo, v.v. (siêu thông tin), tuy nhiên, không cho biết những lời buộc tội này thực sự là về vấn đề gì (thiếu thông tin). Điều này được thực hiện trong trường hợp những lời buộc tội thực sự đúng (trans-informing) và người đọc có thể phát hiện ra sự giả dối của tuyên truyền (siêu thông tin).

---

Правильная ссылка на чужое высказывание является метатрансинформированием.

Tham chiếu chính xác đến tuyên bố của người khác là siêu biến đổi.

---

Измышление чужого высказывания является симуляционным метадезинформирова-нием.

Việc phát minh ra tuyên bố của người khác là một sự mô phỏng siêu thông tin sai lệch.
...
Việc bịt miệng tuyên bố của người khác là một siêu thông tin giả mạo. Phương pháp này thường được sử dụng trong các cuộc bút chiến trên báo khi trích dẫn phát biểu của đối thủ, khi những đoạn văn mâu thuẫn với phát biểu trích dẫn bị bỏ qua. Ví dụ: khi, để làm mất uy tín của tác giả của một bài báo, một câu trích dẫn được đưa ra từ bài báo đó: “trộm cắp là một hành động đáng khen ngợi”, hành vi xuyên tạc thông tin sai lệch sẽ được thực hiện nếu toàn bộ cụm từ ban đầu trông giống như: “trộm cắp là một hành động đáng khen ngợi”. , theo bọn tội phạm.”
...
Bóp méo tuyên bố của người khác là một siêu thông tin sai lệch đơn giản và khó hiểu, trong khi bóp méo nó theo nghĩa ngược lại là một siêu thông tin sai lệch khó hiểu gấp đôi.
...
Việc trích dẫn liên tục tuyên bố của người khác bằng cách thay đổi các công thức tương đương là thông báo metapseudo.

---

Выражение чужого высказывания в обобщающем виде является диссимуляционным метапсевдоинформированием.

Thể hiện tuyên bố của người khác dưới một hình thức khái quát là thông tin metapseudo mang tính giả lập.
...
Thể hiện tuyên bố của người khác dưới một hình thức cho phép diễn giải trái ngược nhau là việc cung cấp thông tin metapseudo khó hiểu.
...
Trích dẫn phát biểu của người khác với hy vọng người đọc sẽ hiểu theo quan điểm ngầm của người trích dẫn là sự chuyển hóa metapara.

---

Если читатель не понял замысла цитирующего, мы имеем дело с диссимуляционным метапарадезинформированием.

Nếu người đọc không hiểu ý định của người trích dẫn, chúng ta đang xử lý việc che giấu thông tin siêu mô tả.

---

Если читатель «обнаружил» несуществующий замысел цитирующего, мы имеем дело с симуляционным метапарадезинформированием.

Nếu người đọc “phát hiện ra” ý định không tồn tại của người trích dẫn, thì chúng ta đang xử lý một mô phỏng thông tin siêu mô hình.

---

Различение информирования и метаинформирования помогает также лучше понять разницу между ложью и обманом.

Việc phân biệt giữa thông tin và thông tin tổng hợp cũng giúp hiểu rõ hơn về sự khác biệt giữa nói dối và lừa dối.
...
Nói dối là thông tin sai lệch, lừa dối là siêu thông tin sai lệch, thể hiện thông tin sai lệch này là thông tin xuyên suốt (lừa dối là việc trình bày lời nói dối là sự thật).
...
Siêu biến đổi bảo vệ chống lại các cáo buộc lừa dối, coi thông tin sai lệch là thông tin sai lệch, tức là dối trá là dối trá.
...
Ví dụ, việc trình bày mối quan hệ đang được nghiên cứu dưới dạng đường cong dựa trên một số phép đo rời rạc là dối trá, vì các đoạn của đường cong giữa các điểm đo là sự tưởng tượng của nhà nghiên cứu, đặc biệt khi một số điểm thực sự như vậy. không phù hợp với đường cong. Tuy nhiên, cáo buộc lừa dối (điều chỉnh hoặc “kéo dài” kết quả) không thể được đưa ra nếu nhà nghiên cứu đã đánh dấu tất cả các điểm đo trên biểu đồ, từ đó cho thấy sự khác biệt giữa vị trí của chúng và đường cong.
...
Tương tự như vậy, những cuộc trò chuyện giữa các nhân vật lịch sử do tác giả tiểu thuyết lịch sử hư cấu đều là dối trá, nhưng từ “tiểu thuyết” đặt dưới tựa đề cuốn sách đã bảo vệ anh ta khỏi bị buộc tội lừa dối.
...
Để xác định thành phần và mối liên kết giữa các thành phần hệ thống, chúng tôi cung cấp các định nghĩa sơ bộ về các khái niệm cơ bản sau.
...
**Hệ thống** (từ tiếng Hy Lạp systema - một tổng thể, một hợp chất được tạo thành từ các bộ phận) là tập hợp các phần tử tương tác với nhau và tạo thành một sự toàn vẹn nhất định.
...
**Tính toàn vẹn của hệ thống** là biểu hiện của tính chất xuất hiện, phản ánh tính không thể quy giản cơ bản của các thuộc tính của hệ thống thành tổng các thuộc tính của các phần tử riêng lẻ của nó, đồng thời, sự phụ thuộc của các thuộc tính của từng phần tử về vị trí và chức năng của nó trong hệ thống.
...
**Phần tử hệ thống** là một phần của hệ thống có mục đích chức năng cụ thể. Trong trường hợp này, một phần tử riêng lẻ của một hệ thống (như chính hệ thống đó) cũng có thể là một phần tử của một hệ thống khác. Các phần tử phức tạp của hệ thống, lần lượt bao gồm các phần tử đơn giản hơn được kết nối với nhau, được gọi là các hệ thống con.
...
**Tổ chức hệ thống** là sự trật tự bên trong, tính nhất quán trong sự tương tác giữa các phần tử hệ thống, thể hiện cụ thể ở việc hạn chế sự đa dạng về trạng thái của các phần tử hệ thống.

---

**Состояние системы** – множество существенных свойств, которыми обладает система.

**Trạng thái hệ thống** là tập hợp các thuộc tính thiết yếu mà hệ thống có.
...
**Cấu trúc hệ thống** – thành phần, trình tự và nguyên tắc tương tác của các phần tử hệ thống, xác định các thuộc tính chính của hệ thống. Cấu trúc là một phần thuộc tính không thay đổi trong hệ thống khi trạng thái của nó thay đổi.

---

**Архитектура системы** – совокупность свойств системы, существенных для ор-ганизации взаимодействия ее составляющих.

**Kiến trúc hệ thống** là tập hợp các thuộc tính hệ thống cần thiết để tổ chức sự tương tác giữa các thành phần của nó.

---

С точки зрения формы существования системы выделяют материальные и аб-страктные системы.

Từ quan điểm về hình thức tồn tại của một hệ thống, các hệ thống vật chất và trừu tượng được phân biệt.
...
**Hệ thống vật chất** là hệ thống năng lượng-vật liệu cung cấp quá trình xử lý thực tế thông tin được trình bày trên phương tiện vật chất. Chúng được chia thành kỹ thuật, ergatic và ergatehnical (hỗn hợp). Chính các hệ thống kỹ thuật erg - hệ thống vật chất “con người-máy móc”, bao gồm yếu tố kỹ thuật erg (con người) và yếu tố kỹ thuật (máy móc) sẽ là đối tượng nghiên cứu chính.
...
**Các hệ thống trừu tượng** là các hệ thống có các hệ thống được lý tưởng hóa chủ yếu làm đối tượng vận hành, ví dụ như kiến ​​thức, lý thuyết, giả thuyết.
...
**Hệ thống thông tin (IS)** là một hệ thống vật chất có chức năng tổ chức, lưu trữ và chuyển đổi thông tin. Đây là một hệ thống có chủ đề và sản phẩm hoạt động chính là thông tin.
...
**Hệ thống xử lý dữ liệu (DPS)** là tập hợp các phương pháp và phương tiện chuyển đổi dữ liệu có liên quan với nhau được trình bày dưới dạng chính thức phù hợp để xử lý tự động với sự tham gia của con người.
...
**Hệ thống xử lý kiến ​​thức (KPS)** là IS tự động có phần mềm đặc biệt để xử lý thông tin logic (ngữ nghĩa).
...
**Hệ thống thông tin thông minh** - hệ thống thông tin có khả năng tổ chức một mảng thông tin theo mức độ quan trọng; trích xuất tất cả thông tin có thể có từ mảng dưới dạng kết quả thu được thông qua logic; hình thành các loại câu hỏi mới để đáp lại việc tiếp nhận thông tin mới từ thế giới bên ngoài; có "sự phản ánh", tức là khả năng đánh giá thông tin được lưu trữ [Smirnov, 1981].
...
Việc xây dựng hệ thống thông tin tự động, mục đích chính là đảm bảo hiệu quả xử lý dữ liệu chuyên ngành, dựa trên các nguyên tắc sau:

- nguyên tắc tích hợp - dữ liệu đã xử lý, sau khi được nhập vào hệ thống, sẽ được sử dụng lại để giải quyết càng nhiều vấn đề càng tốt, từ đó loại bỏ sự trùng lặp dữ liệu và các hoạt động chuyển đổi của chúng càng nhiều càng tốt;
- nguyên tắc nhất quán - xử lý dữ liệu theo nhiều "phần" khác nhau để có được thông tin cần thiết cho việc ra quyết định ở tất cả các cấp và trong tất cả các hệ thống con chức năng;
- nguyên tắc phức tạp – tự động hóa các quy trình chuyển đổi dữ liệu ở tất cả các giai đoạn của quy trình công nghệ.
...
Khái niệm hệ thống tự động có liên quan chặt chẽ đến hiệu quả xử lý, dựa trên sự chuyên môn hóa của các thành phần và quy trình. Sự “chuyên môn hóa” này thường được xác định bởi các thuộc tính của đối tượng đang được xử lý và các nhiệm vụ được xác định trước bởi các mục tiêu của hệ thống.
...
Xét về mục đích và ứng dụng, IP có thể được phân loại theo các tiêu chí sau:

1) theo bản chất của việc sử dụng thông tin thu được:
    - hệ thống truy xuất thông tin, cung cấp việc thu thập, lưu trữ và cung cấp thông tin theo yêu cầu của người dùng;
    - hệ thống thông tin và tư vấn được sử dụng làm hệ thống hỗ trợ quyết định;
    - người quản lý thông tin thực hiện kiểm soát trực tiếp một quá trình hoặc đối tượng phức tạp;
2) theo lĩnh vực (phạm vi) áp dụng:
    - sản xuất;
    - nghiên cứu khoa học;
    - thư viện AIS, tài chính, IS văn phòng, v.v.
3) bởi các đối tượng điều khiển:
    - thiết kế có sự trợ giúp của máy tính;
    - quản lý quy trình công nghệ;
    - quản lý doanh nghiệp, v.v.
4) theo mức độ tự động hóa của quá trình xử lý:
    - với việc xử lý thông tin thủ công;
    - xử lý thông tin cơ giới hóa;
    - xử lý thông tin tự động;
    - Xử lý thông tin tự động.
5) theo mức độ chuyên môn hóa của ứng dụng có thể:
    - phổ quát;
    - chuyên biệt (định hướng vấn đề).
...
Một khía cạnh khác của kiểu chữ IS là kiểu “thông tin”, trong đó các đặc điểm phân loại được xác định bởi các đặc điểm của công nghệ xử lý thông tin, các đặc tính của chúng được chuyển giao cho hệ thống. Từ quan điểm này, hệ thống thông tin có thể được phân loại theo các tiêu chí sau:
...
1. Dựa trên loại thông tin được lưu trữ, người ta có thể phân biệt (không bao gồm thông tin đa phương tiện) các hệ thống thông tin sự kiện, tài liệu và từ điển.
...
Các hệ thống thực tế tập trung vào việc xử lý dữ liệu, bối cảnh sử dụng được xác định trước và thường được cố định trong lược đồ dữ liệu hoặc trong các quy trình xử lý.
...
Hệ thống thông tin tài liệu được phân chia theo mức độ trình bày thông tin - toàn văn (xử lý cái gọi là tài liệu “chính”) và thư mục-tóm tắt (xử lý tài liệu “thứ cấp”, phản ánh tài liệu chính ở cấp độ địa chỉ và nội dung). Bối cảnh sử dụng dữ liệu trong hệ thống thông tin tài liệu có thể khác với bối cảnh được xác định khi nó được tạo.
...
Từ điển học là các bộ phân loại, bộ mã hóa, từ điển các từ cơ bản, từ điển đồng nghĩa, bộ đánh giá, v.v., thường được sử dụng làm tài liệu tham khảo kết hợp với cơ sở dữ liệu tài liệu hoặc thực tế và cho phép, cùng với những thứ khác, xác định thêm ngữ cảnh của dữ liệu.
...
2. Dựa trên loại mô hình dữ liệu DBMS được sử dụng để triển khai hệ thống thông tin, ba lớp được phân biệt theo truyền thống: phân cấp, mạng, quan hệ.
3. Dựa trên cấu trúc liên kết lưu trữ dữ liệu, hệ thống thông tin cục bộ và hệ thống thông tin phân tán được phân biệt.
4. Dựa trên hiệu quả sử dụng dữ liệu, có thể phân biệt thông tin vận hành và thông tin tham khảo. Loại thứ hai bao gồm AIS của thông tin hồi cứu (danh mục thư viện điện tử, cơ sở dữ liệu thông tin thống kê, v.v.), được sử dụng để hỗ trợ các hoạt động cốt lõi và thường không liên quan đến việc thay đổi các hồ sơ hiện có. IS vận hành được thiết kế để phản ánh kịp thời trạng thái và quyền kiểm soát các đối tượng cũng như quy trình công nghệ của SbA. Trong trường hợp này, dữ liệu không chỉ được lấy từ cơ sở dữ liệu mà còn được thay đổi và bổ sung, bao gồm cả kết quả của việc sử dụng nó.
5. Theo mức độ sẵn có của thông tin, hệ thống thông tin có thể được chia thành hệ thống công khai và hệ thống có hạn chế về quyền truy cập của người dùng vào tài nguyên hệ thống. Trong trường hợp sau, chúng ta nói về quyền truy cập được ủy quyền, quyền truy cập này xác định riêng lẻ không chỉ tập hợp dữ liệu mà còn cả các hoạt động có sẵn cho một người dùng cụ thể.
...
Cần lưu ý rằng sự phân loại được trình bày không đầy đủ: nó phản ánh tình hình lịch sử trong lĩnh vực hoạt động liên quan đến phát triển và ứng dụng công nghệ và hệ thống thông tin.
...
Thành phần chính và xác định của bất kỳ hệ thống nào là các tổ hợp dữ liệu và quy trình xử lý chúng được liên kết với nhau về mặt chức năng. Chúng ta hãy lưu ý rằng những phức hợp này, dù riêng lẻ hay cùng nhau, vẫn chưa tạo ra tính toàn vẹn đặc trưng của hệ thống. Các thuộc tính của hệ thống xuất hiện khi IS được xem xét trong động lực học của mối quan hệ với môi trường, nghĩa là khi các yếu tố về khả năng kiểm soát và khả năng thích ứng với các điều kiện bên ngoài thay đổi và độ ổn định theo thời gian trở nên đáng kể. Đó là lý do tại sao bất kỳ hệ thống nào, ngoài các thành phần chức năng - những thành phần chính xét theo mục đích của hệ thống, phải bao gồm các thành phần tổ chức và hỗ trợ, mục đích của chúng là tạo ra các điều kiện cần thiết để hoạt động, bao gồm cả hình thành các chủ thể quản lý. Đổi lại, IS là một phần không thể thiếu của một số hệ thống lớn hơn nhằm đảm bảo đạt được mục tiêu cụ thể trong hoạt động của con người.
...
Hầu hết tất cả các hệ thống thông tin hiện đại đều bao gồm các hệ thống máy tính tạo thành thành phần vật lý của hệ thống. Các thành phần như vậy bao gồm cả bộ nhớ ngoài và các phương tiện kỹ thuật và tính toán trực tiếp cung cấp khả năng xử lý và tương tác của người dùng với IS.
...
Thành phần thứ hai là phần mềm (quy trình) và công nghệ đảm bảo hoạt động của hệ thống. Ở đây, một hệ thống con để quản lý dữ liệu chung thường được phân biệt riêng biệt, cũng như các quy trình xử lý chức năng chuyên biệt phản ánh các yêu cầu của lĩnh vực chủ đề.
...
Tuy nhiên, ở mức độ lớn nhất, bản chất của AIS được thể hiện bởi thành phần thứ ba - quỹ thông tin, được đặc trưng không chỉ bởi thông tin chứa đựng mà còn bởi cách tổ chức (mô hình dữ liệu), cũng như bởi hình thức trình bày, do đó, được xác định bởi khả năng hỗ trợ học tập ngôn ngữ - ngôn ngữ để trình bày và quản lý thông tin. Hỗ trợ ngôn ngữ đại diện cho bản chất (chức năng và khả năng kiểm soát) của AIS, cung cấp một lớp “lan tỏa” giữa môi trường “tự nhiên”, thường là năng lượng-vật chất của SbA và môi trường thông tin, có tính chất nhân tạo chủ yếu là trừu tượng. thiên nhiên.

---

Примерный организационно-функциональный состав АИС приведен на рис. 2.1.

Thành phần tổ chức và chức năng gần đúng của AIS được hiển thị trong Hình 2. 2.1.
...
Các hệ thống con chức năng thực hiện và hỗ trợ các mô hình, phương pháp và thuật toán để xử lý thông tin và tạo ra các hành động kiểm soát trong khuôn khổ nhiệm vụ của lĩnh vực chủ đề, tức là thành phần và mục đích của các hệ thống con chức năng phụ thuộc vào lĩnh vực chủ đề và các tính năng của việc sử dụng IS . Trong hình. 2.1 liệt kê một số lĩnh vực có chức năng khá rõ ràng. Chúng tôi chỉ lưu ý rằng hệ thống con hỗ trợ thông tin là một phần của bất kỳ hoạt động nào, vì nó quyết định chất lượng của công việc nghiên cứu (bao gồm cả tiếp thị), thiết kế và chuẩn bị công nghệ cho sản xuất.
...
Thành phần của các hệ thống con hỗ trợ khá ổn định và thường phụ thuộc ít vào lĩnh vực sử dụng của IS. Chúng ta hãy lưu ý các thành phần sau:

- phần mềm – một tập hợp các thành phần phần mềm được sử dụng thường xuyên, cần thiết để giải quyết các vấn đề chức năng và các chương trình cho phép sử dụng công nghệ máy tính hiệu quả nhất, mang lại cho người dùng sự thuận tiện nhất trong công việc;
- phần mềm - một tập hợp các phương pháp, mô hình và thuật toán để xử lý thông tin được sử dụng trong hệ thống;
- hỗ trợ ngôn ngữ (LS) là một bộ công cụ ngôn ngữ cung cấp tính linh hoạt và trình bày và xử lý thông tin đa cấp trong AIS. Thông thường, LO bao gồm các ngôn ngữ truy vấn và báo cáo, các ngôn ngữ đặc biệt để xác định và quản lý dữ liệu, đảm bảo tính đầy đủ của cách biểu diễn bên trong và sự phối hợp của các cách biểu diễn bên trong và bên ngoài. LO phụ thuộc phần lớn vào đặc điểm của lĩnh vực chủ đề.
...
Các hệ thống con của tổ chức cũng thuộc về các hệ thống con hỗ trợ, nhưng chủ yếu nhằm mục đích đảm bảo hoạt động hiệu quả của nhân sự và toàn bộ hệ thống, do đó có thể được phân biệt riêng biệt. Lưu ý rằng việc phát triển hệ thống thông tin nên bắt đầu bằng sự hỗ trợ về mặt tổ chức: chứng minh tính khả thi của hệ thống, các chỉ số kinh tế xác định hoạt động của nó, thành phần của các hệ thống con chức năng, cơ cấu quản lý tổ chức, sơ đồ công nghệ để chuyển đổi thông tin, trình tự công việc, vân vân.
...
Sự lưu thông thông tin, giống như bất kỳ sản phẩm nào của hoạt động con người, đều tuân theo chu kỳ tự nhiên là “sáng tạo-phân phối-tiêu dùng”. Mặc dù thực tế là thông tin không bị phá hủy về mặt vật lý và không biến mất trong quá trình tiêu thụ (không giống như hầu hết các hàng hóa, tài nguyên vật chất và vật mang thông tin), khi xem xét các vấn đề này về lâu dài, rõ ràng là tài nguyên thông tin, khi chuyển sang dạng mới, sẽ tan biến. trong đó gần như không có dấu vết. Đó là, một tình huống xảy ra khi việc phát minh lại dễ dàng hơn là tìm ra nguồn ban đầu.
...
Trong chu trình trao đổi thông tin truyền thống, luồng thông tin tài liệu chính đi theo chuỗi tác giả – nhà xuất bản – thư viện – độc giả, nhưng cũng có những cách giải quyết, ví dụ: tác giả – độc giả; nhà xuất bản-đọc giả (đăng ký). Sự chuyển đổi vào đầu những năm 70 của dịch vụ thông tin sang sao chép thứ cấp thứ nhất (tạp chí tóm tắt, danh mục, ấn phẩm tham khảo) và sau đó là tài liệu chính (toàn văn) ở dạng máy đọc được về nguyên tắc không vi phạm cấu trúc chung này.
...
Nhà cung cấp nội dung là bất kỳ người tham gia nào trong quá trình này: tác giả (cá nhân hoặc tập thể), nhà xuất bản hoặc thư viện. Việc xuất bản cơ sở dữ liệu và dịch vụ trực tuyến cũng không bị cấm đối với bất kỳ ai. Ví dụ, một trong những hệ thống thông tin lớn nhất về khoa học tự nhiên - INSPEC - được phát triển từ dịch vụ thư viện của Viện (Viện Kỹ sư Điện, Vương quốc Anh). Mạng thông tin, đại diện cho môi trường giao tiếp cho người dùng cuối, thường là một phần của nhà xuất bản hoặc nhà phân phối cơ sở dữ liệu, tạo thành các dịch vụ thông tin phân tán tích hợp. Cơ sở hạ tầng điện tử tạo thành một lớp tương đối độc lập, không phải là hình ảnh phản chiếu của truyền thông truyền thống. Xuất hiện vào cuối thập niên 80 - đầu thập niên 90. một yếu tố mới – Internet toàn cầu với các tài nguyên/dịch vụ thông tin của nó chỉ bổ sung cho bức tranh tổng thể.
...
Việc giảm chi phí và phân phối rộng rãi các thiết bị liên lạc, dịch vụ liên lạc (với sự gia tăng năng suất của chúng), cũng như mức độ tiêu chuẩn hóa cao về định dạng, giao thức truyền dữ liệu và phần mềm - tất cả điều này đã dẫn đến sự tích hợp mạng thông tin của tổ chức vật lý và băng thông khác nhau vào một môi trường đồng nhất, “tính minh bạch” của môi trường này đang tăng nhanh theo thời gian theo mọi hướng.
...
Nếu mục đích của hệ thống thông tin chỉ là lưu trữ và tìm kiếm dữ liệu theo mảng bản ghi thì cấu trúc của hệ thống và cơ sở dữ liệu sẽ đơn giản. Lý do cho sự phức tạp là ở chỗ hầu hết mọi đối tượng đều được đặc trưng không chỉ bởi các tham số-đại lượng mà còn bởi mối quan hệ qua lại giữa các bộ phận hoặc trạng thái. Ngoài ra, như đã lưu ý ở trên, bản thân một phần tử dữ liệu riêng lẻ (giá trị của nó) chỉ có ý nghĩa (ý nghĩa) khi nó được liên kết với ngữ cảnh - bản chất của giá trị (các phần tử dữ liệu khác), điều này sẽ cho phép nó được diễn giải.
...
Một đối tượng vật chất (ví dụ: nhân viên, sản phẩm hoặc địa điểm) hoặc vật thể vô hình (ví dụ: tên, khái niệm, ý tưởng trừu tượng) có thể có nhiều thuộc tính khác nhau (ví dụ: màu sắc, trọng lượng, tên) quan trọng đối với chúng ta tại thời điểm chúng ta chuyển sang nó (ví dụ, chọn trong số nhiều thứ khác) cho mục đích sử dụng nào đó. Hơn nữa, các đặc tính có thể được xác định bằng cả các chỉ số định lượng được diễn giải rõ ràng riêng lẻ và bằng các mô tả mờ bằng lời nói cho phép diễn giải khác nhau, chẳng hạn như tùy thuộc vào quan điểm và kiến ​​thức hiện có của chủ thể nhận thức.
...
Yếu tố chung là một người, khi làm việc với thông tin, xử lý một phần trừu tượng đại diện cho một phần của thế giới thực mà anh ta quan tâm - tập hợp các thuộc tính (thuộc tính) đặc trưng đó quan trọng để giải quyết vấn đề được áp dụng của anh ta. Trừu tượng hóa là một cách đơn giản hóa một tập hợp các sự kiện liên quan đến một đối tượng thực tế (vốn vô cùng phức tạp và đa dạng). Trong trường hợp này, một số thuộc tính của đối tượng bị bỏ qua, vì người ta tin rằng để giải quyết một vấn đề (hoặc tập hợp các vấn đề) nhất định, chúng không mang tính quyết định và không ảnh hưởng đến kết quả cuối cùng. Nghĩa là, nhiệm vụ của quá trình trừu tượng hóa là xây dựng một mô tả hoạt động mang tính xây dựng (mô hình làm việc), thuận tiện cho việc xử lý cho cả con người và máy móc, cho phép thiết kế và thực hiện xử lý thông tin hiệu quả, chứ không chỉ công việc phải có năng suất tính toán cao. hệ thống mà còn cả con người tương tác với nó.
...
Trong trường hợp chung, đối với các hệ thống phức tạp có cách biểu diễn ngữ nghĩa đa cấp, hiệu quả xử lý đạt được thông qua việc chuyên môn hóa cách biểu diễn các đối tượng hoặc quy trình bằng cách giảm cách biểu diễn các đối tượng được xử lý thành những đối tượng có bản chất và hình thức biểu diễn đồng nhất. Điều này có nghĩa là để thực hiện tương tác giữa các cấp độ (liên thành phần) hiệu quả (tại mỗi đối tượng được trình bày dưới dạng phù hợp nhất với các phương tiện chức năng của cấp độ hoặc quy trình này), mọi giá trị phải được chuyển đổi theo “ngữ cảnh” của cấp độ này để có được cách thể hiện nó sẽ “có ý nghĩa” đối với cấp độ nhận thức, tức là có thể được xử lý bằng cấp độ này. Ở đây, “ngữ cảnh” là một định nghĩa mang tính khai báo hoặc mang tính thủ tục về cách thức sử dụng các thành phần cơ bản của một đại lượng để đạt được ý nghĩa. Ví dụ: ngữ cảnh là thứ tự sử dụng byte khi chuyển đổi một số thực được biểu thị ở dạng nhị phân thành định dạng ký tự.
...
Mối quan hệ giữa các khái niệm về kích thước, bối cảnh và ý nghĩa được thể hiện ở hình 2. 1.7. Ở đây, giá trị thu được trong quy trình đầu tiên (ở cấp độ đầu tiên), ở quy trình tiếp theo lần lượt được coi là giá trị sẽ được diễn giải theo ngữ cảnh của quy trình 5.
...
Vì vậy, chúng ta có thể nói rằng giá trị được xác định bởi cặp <độ lớn, bối cảnh>. Hơn nữa, vì bối cảnh và số lượng nói chung có bản chất khác nhau nên chúng phải được biểu diễn trong môi trường điện toán dưới dạng các đối tượng độc lập, rất có thể, thuộc các loại khác nhau.
...
Theo nghĩa này (từ quan điểm của phương pháp trình bày và theo đó là nhận thức), thông tin thực tế có thể được phân biệt thành một lớp riêng biệt: sự thể hiện các sự kiện và hiện tượng thực sự tồn tại, khi chúng có thể được mô tả dưới dạng các sự kiện được chỉ định bởi cặp `<name, value>` , trong đó tên là dấu hiệu xác định (xác định) duy nhất một sự kiện trong một lĩnh vực chủ đề nhất định và thường không cần định nghĩa rõ ràng hoặc định nghĩa sâu hơn về bản chất của nó; và giá trị là một đặc tính chỉ định một trong nhiều trạng thái có thể có.

```{figure} l1-7.png
Рис. 1.7. Соотношение понятий «величина», «контекст» и «значение»
```

То есть здесь факт (его значение) задается величиной, например, числовой, для физически измеримых параметров и логическими величинами «истина»/«ложь» для указания, свершилось событие или нет.

Nghĩa là, ở đây, một thực tế (giá trị của nó) được chỉ định bởi một giá trị, ví dụ: một giá trị số, cho các tham số có thể đo lường được về mặt vật lý và các giá trị logic “true”/“false” để cho biết liệu sự kiện có xảy ra hay không.
...
Chúng ta có thể nói rằng một đặc điểm của thông tin thực tế là tính hiển nhiên trong thực tế (độ không chắc chắn tối thiểu, không yêu cầu sử dụng các thủ tục phức tạp hoặc không rõ ràng) trong việc xác định và giải thích “sự kiện” (tên và trạng thái của nó). Và trong trường hợp này, ngữ cảnh được xác định đầy đủ bằng cách khai báo được hiểu rõ ràng về mục đích của dữ liệu và bằng cách đặt tên các trường dữ liệu theo cách mà tên thuộc tính độc lập với ứng dụng được chấp nhận rộng rãi được sử dụng làm tên (và do đó, các đặc điểm đặc trưng được xác định). Chính trạng thái này xác định trước cho người dùng khả năng nhận thức đầy đủ nội dung: phương pháp diễn giải dữ liệu trong trường hợp này hầu như luôn rõ ràng và đối với người dùng, việc xác định phương pháp thường diễn ra một cách ngầm định (không yêu cầu các hành động rõ ràng từ anh ta để xác định và sử dụng bối cảnh). Điều này một mặt cho phép chúng ta giảm việc biểu diễn lĩnh vực chủ đề thành một mô hình lý thuyết tập hợp chính xác, mặt khác, nó cho phép sử dụng trực tiếp dữ liệu trong các tác vụ xử lý (ở cấp độ chương trình ứng dụng) để tạo ra thông tin mới mà không cần sự tham gia của một chủ thể (một người bên ngoài môi trường máy) cung cấp định nghĩa và cách sử dụng ngữ cảnh.
...
Tuy nhiên, hầu hết các vấn đề do con người giải quyết không thể rút gọn thành biểu diễn “thực tế” và được mô tả (và theo đó, được trình bày trong môi trường máy móc) bằng cách sử dụng các ngôn ngữ tự nhiên hoặc chuyên biệt hoạt động với các biến ngôn ngữ, ý nghĩa của chúng có thể phụ thuộc vào chỉ dựa trên bối cảnh của lĩnh vực chủ đề mà còn dựa trên bối cảnh của môi trường trực tiếp - giá trị của các biến lân cận. Hơn nữa, sự xuất hiện của một ý nghĩa (sự kiện) mới không nhất thiết dẫn đến sự xuất hiện của một biến số mới: một sự kiện mới có thể được biểu diễn bằng cách sử dụng các biến số đã có sẵn. Ví dụ, định nghĩa bằng lời nói về các khái niệm toán học hoặc địa lý.
...
Ngược lại với cách biểu diễn sự kiện đã thảo luận trước đó, hình thức biểu diễn sự kiện bằng lời nói (biểu thức của ngôn ngữ sử dụng các biến ngôn ngữ) được đặc trưng bởi thực tế là một phương pháp và phương tiện duy nhất có thể được sử dụng để đặt tên, ý nghĩa và bối cảnh - các thành phần của sự việc. cùng một ngôn ngữ. Ví dụ: mô tả về đặc tính trọng lượng có thể được biểu thị bằng nhiều biến thể của câu, nhưng có cùng ý nghĩa: “Một phôi gang nặng 29 kg” hoặc “Một phôi gang có tính chất m = 29, trong đó m là trọng lượng tính bằng kilôgam”, v.v.
...
Việc tự động giảm loại biểu diễn này thành dạng bảng rõ ràng là tốt nhất cho trường hợp này sẽ yêu cầu sử dụng các quy trình khó thực hiện trong phân tích hình thái và ngữ nghĩa. Tuy nhiên, mặt khác, việc lựa chọn ý nghĩa (và tạo ra thông tin mới) thường được thực hiện bởi một người có ý thức (như một môi trường biến đổi) tập trung đặc biệt vào việc xử lý các biến ngôn ngữ.
...
Các trường hợp thông tin được trình bày dưới dạng không phù hợp với dạng nhị phân (yêu cầu các phép biến đổi bổ sung) có thể do nhiều yếu tố khác nhau. Hãy xem xét các trường hợp sau đây.
...
1. Thông tin chính xác (dễ hiểu rõ ràng) được trình bày ở định dạng đặc biệt (cụ thể là đồ họa). Ví dụ: công thức hóa học cấu trúc, tài liệu thiết kế, v.v. Trong trường hợp này, quá trình xử lý tự động đòi hỏi các công cụ chuyên môn cao, dẫn đến sự thiếu thống nhất chung của bản trình bày ở cấp độ dữ liệu (trong ví dụ này là đồ họa nguyên thủy).
2. Thông tin đúng về nội dung nhưng được trình bày khác về hình thức. Ví dụ: mô tả ở dạng văn bản về các thông số được chỉ định bằng số của sản phẩm. Các biến ngôn ngữ trong trường hợp này có ý nghĩa chính xác, nhưng việc xây dựng một quy trình chung để tự động trích xuất một sự kiện từ văn bản đòi hỏi nhiều công sức.
3. Thông tin bán cấu trúc, thường được trình bày dưới dạng văn bản. Ví dụ: một ấn phẩm giáo dục hoặc khoa học trong đó các khái niệm mới được xây dựng trên cơ sở những khái niệm đã được xác định trước đó. Trong trường hợp này, giá trị của biến ngôn ngữ có thể nhận các giá trị mới, chưa được xác định trước đó, được xác định bởi ngữ cảnh - đóng (tổ hợp từ) hoặc chung (chủ đề tin nhắn).
...
Cũng cần lưu ý rằng tính cấu trúc không chỉ đề cập đến hình thức trình bày dữ liệu (định dạng, phương thức lưu trữ) mà còn đề cập đến cách người dùng diễn giải giá trị: giá trị tham số không chỉ được trình bày ở dạng được xác định trước mà còn thường đi kèm với chỉ dẫn về thứ nguyên của giá trị, cho phép người dùng hiểu ý nghĩa của nó mà không cần bình luận thêm. Vì vậy, chúng ta có thể nói rằng dữ liệu thực tế ngụ ý khả năng giải thích trực tiếp của chúng.
...
Tuy nhiên, phương pháp quy kết ở “dạng thuần túy” của nó không hiệu quả trong việc xác định thông tin có cấu trúc yếu liên quan đến các đối tượng thường có tính chất lý tưởng (suy đoán) - danh mục, khái niệm, hệ thống ký hiệu. Các đối tượng như vậy thường được xác định gián tiếp - thông qua các đối tượng khác sử dụng ngôn ngữ tự nhiên hoặc nhân tạo (ví dụ: ngôn ngữ toán học). Theo đó, để hiểu ý nghĩa, người dùng cần sử dụng các quy tắc ngôn ngữ phù hợp và hơn nữa, thường cần phải có sẵn dữ liệu cho phép họ xác định và liên kết thông tin nhận được với kiến ​​​​thức hiện có. Nghĩa là, quá trình diễn giải loại dữ liệu này là gián tiếp và yêu cầu sử dụng thông tin bổ sung, trong trường hợp chung, thông tin này không nhất thiết phải xuất hiện ở dạng chính thức cùng với thông điệp (dữ liệu), thực chất là thông tin. Chúng ta có thể nói rằng sự khác biệt chính giữa các hệ thống thông tin tài liệu là cách diễn giải dữ liệu gián tiếp chứ không phải cách tổ chức của chúng.
...
Do đó, việc sắp xếp dữ liệu vật lý (và theo đó, việc xác định cấu trúc của bản ghi vật lý) phải được đi trước bằng mô tả cấu trúc logic của lĩnh vực chủ đề - việc xây dựng mô hình của mảnh tương ứng của thế giới thực , chỉ làm nổi bật những đối tượng mà người dùng trong tương lai sẽ cần và chỉ được biểu thị bằng những tham số có ý nghĩa quan trọng khi giải quyết các vấn đề ứng dụng. Một mô hình như vậy có rất ít sự giống nhau về mặt vật lý với thực tế, nhưng sẽ hữu ích trong việc thể hiện thế giới thực của người dùng. Điều quan trọng là cách biểu diễn này được mô tả bằng các phương tiện thân thiện với người dùng, nhưng đồng thời nó sẽ cung cấp khả năng thao tác trong môi trường điện toán cứng nhắc với cách biểu diễn thông tin bằng số mà con người không thể đáp ứng được.
...
Vì vậy, trước khi mô tả việc triển khai vật lý của các đối tượng và kết nối giữa chúng, cần xác định:

1) cách người dùng thể hiện (mô tả) các đối tượng và kết nối;
2) hình thức và phương pháp biểu diễn trong máy các phần tử dữ liệu và các mối quan hệ;
3) có nghĩa là cung cấp các phép biến đổi một-một của các biểu diễn bên ngoài và bên trong máy.
...
Cách tiếp cận này là một sự thỏa hiệp: do một tập hợp trừu tượng được xác định trước phổ biến cho hầu hết các tác vụ xử lý dữ liệu, cung cấp khả năng xây dựng các chương trình xử lý đáng tin cậy. Người dùng, sử dụng một tập hợp hạn chế các khái niệm hình thức nhưng khá quen thuộc, làm nổi bật các thực thể và kết nối, mô tả các đối tượng và kết nối của lĩnh vực chủ đề; người lập trình, sử dụng các khái niệm trừu tượng tiêu chuẩn như vậy (chẳng hạn như số, tập hợp, tập hợp dữ liệu), xác định các cấu trúc thông tin tương ứng. Hệ thống quản lý dữ liệu, sử dụng các dạng nhị phân để biểu diễn dữ liệu được đánh máy, cung cấp các quy trình hiệu quả để lưu trữ và xử lý dữ liệu.
...
Ở tất cả các cấp độ này, khái niệm trừu tượng về cấu trúc được sử dụng:

- cấu trúc thông tin - dạng sơ đồ (cung cấp sự chuyển đổi sang dạng thuộc tính) biểu diễn các đối tượng thành phần phức tạp và các kết nối của một lĩnh vực chủ đề thực, được xác định là cần thiết khẩn cấp để giải quyết các vấn đề ứng dụng, trong trường hợp chung, mà không tính đến liệu các công cụ sẽ được sử dụng để giải quyết vấn đề lập trình và máy tính hay không. Trong trường hợp trình bày SbA có cấu trúc yếu (dạng tài liệu), cũng cần phải xem xét cấu trúc của văn bản, điều này giúp có thể tách biệt các thành phần có ý nghĩa ngữ nghĩa của văn bản và xác định vai trò của chúng. Hiệu quả ở đây được xác định bởi mức độ trừu tượng, cũng như tính đầy đủ và chính xác của việc thể hiện các thuộc tính thông qua hệ thống đặc tính đã chọn;
- cấu trúc dữ liệu – một dạng thuộc tính thể hiện các thuộc tính và kết nối của SbA, tập trung vào việc thể hiện mô tả dữ liệu bằng các ngôn ngữ chính thức (nghĩa là có tính đến khả năng và hạn chế của các công cụ cụ thể để giảm mô tả thành các loại tiêu chuẩn và kết nối thường xuyên). Hiệu quả trong trường hợp này gắn liền với quá trình xây dựng một chương trình (“người giải” một bài toán ứng dụng) và theo một nghĩa nào đó, gắn liền với hiệu quả của người lập trình;
- cấu trúc hồ sơ – có tính đến các đặc điểm của môi trường vật lý, việc thực hiện các phương pháp lưu trữ dữ liệu và tổ chức truy cập dữ liệu ở cấp độ hồ sơ riêng lẻ và các thành phần của chúng. Hiệu quả trong trường hợp này liên quan đến quá trình trao đổi giữa RAM và các thiết bị bộ nhớ ngoài và được đảm bảo bằng tính dự phòng dữ liệu, được đưa vào một cách giả tạo để đảm bảo hiệu quả chức năng của các hoạt động riêng lẻ (ví dụ: tìm kiếm bằng phím).
...
Cấu trúc là một công cụ thuận tiện và được chấp nhận rộng rãi, được sử dụng hiệu quả như nhau cả ở cấp độ ý thức của con người khi làm việc với các khái niệm trừu tượng và ở cấp độ logic của các thuật toán máy. Cấu trúc giúp đơn giản hóa tính đa chiều của mô tả nội dung thành một chuỗi tuyến tính của các bản ghi, và trong một số trường hợp, chính mô tả cấu trúc đó thể hiện bối cảnh sử dụng dữ liệu.
...
Dựa trên loại thông tin được lưu trữ, người ta có thể phân biệt (không bao gồm thông tin đa phương tiện) các hệ thống thông tin sự kiện, tài liệu và từ điển.
...
**Từ điển** là các bộ phân loại, bộ mã hóa, từ điển các từ cơ bản, từ điển đồng nghĩa, bộ đánh giá, v.v., thường được sử dụng làm tài liệu tham khảo kết hợp với cơ sở dữ liệu tài liệu hoặc thực tế và cho phép, cùng với những thứ khác, xác định thêm ngữ cảnh của dữ liệu.

## 11.	Основные требования, предъявляемые к базам данных. Преимущества и недостатки использования баз данных.

Важнейшими особенностями информационных систем, основанных на концепциях баз данных являются: 

- многоаспектность представления29 информации и, в том числе основанная на наиболее часто используемом принципе разделения физического и логического представлений; 
...
Các tính năng quan trọng nhất của hệ thống thông tin dựa trên khái niệm cơ sở dữ liệu là:

- trình bày thông tin đa chiều29, bao gồm thông tin dựa trên nguyên tắc được sử dụng phổ biến nhất là tách biệt các biểu diễn vật lý và logic;
- tính đa dạng và linh hoạt của việc xử lý (sử dụng để giải quyết các vấn đề ứng dụng khác nhau) của thông tin sau khi được lưu (được tạo) và do đó, nhu cầu xử lý các truy vấn không được cung cấp trước (khi tạo cơ sở dữ liệu).
...
Tuy nhiên, đối với hệ thống tài liệu, một yếu tố khác ảnh hưởng đến hiệu quả làm việc của con người với thông tin cũng rất quan trọng - đó là hình thức lưu trữ và trình bày (thiết kế) của tài liệu. Điều này đặc biệt đáng chú ý khi làm việc với các tài liệu toàn văn lớn, khi khả năng xử lý tiếp theo phụ thuộc vào việc lựa chọn định dạng (DOC, PDF, HTML, v.v.).
...
Theo đó, các công nghệ tìm kiếm (thuật toán) dựa trên hai kiểu tổ chức của một mảng đối tượng tìm kiếm - trực tiếp và đảo ngược.

---

В случае **прямой организации массива записей** (хранилища документов) обычно размещаются в порядке их поступления. При прямой организации поиск в больших массивах будет требовать достаточно много времени, так как для сравнения с запросом надо последовательно выбирать все10 документы из хранилища, по той простой причине, что, не обратившись к документу, мы не можем судить о его содержании.

Trong trường hợp tổ chức trực tiếp một mảng hồ sơ (lưu trữ tài liệu), chúng thường được sắp xếp theo thứ tự nhận được. Với cách tổ chức trực tiếp, việc tìm kiếm trong mảng lớn sẽ tốn khá nhiều thời gian, vì để so sánh với một truy vấn, chúng ta phải chọn tuần tự cả 10 tài liệu từ kho, vì lý do đơn giản là không truy cập vào tài liệu thì không thể phán đoán được. nội dung của nó.

--

**Инвертированная форма организации массива** предполагает, что записи могут быть упорядочены, например, разбиты на подмножества, которые, в свою очередь, упо-рядочены в соответствии с величиной атрибута. Такое упорядочение записей (обычно, виртуальное т.к. нерационально переписывать и сортировать исходный массив) сопро-вождается построением вспомогательной структуры – инвертированного справочника, в котором с каждым индексом (ключом - идентификатором подмножества) связан спи-сок ссылок на документы, отнесенные к этому подмножеству. Например, систематиче-ский или авторский каталоги библиотеки имеют типично инвертированную организа-цию: карточки с шифром раздела представляют собой индекс, а инвертированный спи-сок – это распложенные за ней карточки с шифрами хранения соответствующих еди-ниц. Таких инвертированных списков может быть много и разных по атрибуту упорядочения, но при этом массив единиц хранения будет один и порядок размещения будет тоже единым.

Hình thức tổ chức mảng đảo ngược giả định rằng các bản ghi có thể được sắp xếp theo thứ tự, ví dụ, được chia thành các tập hợp con, lần lượt được sắp xếp theo giá trị thuộc tính. Thứ tự các bản ghi này (thường là ảo vì việc viết lại và sắp xếp mảng ban đầu là không hợp lý) đi kèm với việc xây dựng một cấu trúc phụ trợ - một thư mục đảo ngược, trong đó mỗi chỉ mục (khóa - định danh tập hợp con) được liên kết với một danh sách liên kết đến các tài liệu liên quan đến tập hợp con này. Ví dụ: danh mục thư viện của tác giả hoặc hệ thống có cách tổ chức đảo ngược điển hình: thẻ có mã phần biểu thị một chỉ mục và danh sách đảo ngược là thẻ có mã lưu trữ cho các đơn vị tương ứng nằm phía sau nó. Có thể có nhiều danh sách đảo ngược như vậy và thuộc tính sắp xếp khác nhau, nhưng mảng đơn vị lưu trữ sẽ giống nhau và thứ tự sắp xếp cũng sẽ giống nhau.

## 13.	Назначение и типы информационно-поисковых языков. Обобщенная булево-подобная форма выражения запроса документальных ИС.

## 14.	Типы информационной неопределенности при поиске.
...
**Hỗ trợ ngôn ngữ (LS)** là một bộ công cụ ngôn ngữ mang lại sự linh hoạt trong việc trình bày và xử lý thông tin bằng AIS. Ở đây, ngôn ngữ không chỉ đóng vai trò là phương tiện giao tiếp giữa các yếu tố hoạt động ở cùng cấp độ (con người-con người hoặc AIS-AIS) mà còn cung cấp sự tương tác giữa con người và máy móc. Thông thường, LO bao gồm các ngôn ngữ truy vấn và báo cáo thực hiện tương tác giữa người và máy, cũng như các ngôn ngữ đặc biệt để xác định và quản lý dữ liệu nhằm đảm bảo tính đầy đủ của biểu diễn bên trong và sự phối hợp của các biểu diễn bên trong và bên ngoài. Rõ ràng đây là lý do tại sao LO phần lớn phụ thuộc vào đặc điểm của lĩnh vực chủ đề: một mặt, vào các yêu cầu về tính đầy đủ và chính xác của việc truyền tải thông tin (ý nghĩa), mặt khác, vào các yêu cầu đối với sự thống nhất của ngôn ngữ và sự dễ dàng của việc học và sử dụng nó. 
...
Chương này sẽ tập trung vào các ngôn ngữ truy xuất thông tin1, mục đích chính của ngôn ngữ này không phải là truyền tải chính xác ý nghĩa của thông điệp mà là tìm các thông điệp chứa thông tin có thể hữu ích. Trong hình. 5.1 trình bày một loại phương pháp mô tả nội dung tài liệu.
...
Phân loại, như một phương tiện mô tả nội dung của tài liệu, là quá trình tương quan giữa nội dung của tài liệu với các khái niệm được ghi trong các sơ đồ hệ thống được biên soạn trước. 
...
Ngôn ngữ kiểu mô tả thực hiện lập chỉ mục, bao gồm việc hình thành mô tả tài liệu dưới dạng một tập hợp các bộ mô tả được chọn từ từ điển khái niệm được tạo trước hoặc từ văn bản tài liệu.
...
**Ngôn ngữ** là một hệ thống ký hiệu có tính chất vật lý bất kỳ, thực hiện chức năng nhận thức và giao tiếp trong quá trình hoạt động của con người. Tính đa nghĩa của các từ trong ngôn ngữ tự nhiên, mang lại “những khả năng phong phú nhất để thể hiện hoàn toàn rõ ràng những sắc thái tinh tế nhất của tư tưởng” [Mikhailov, 1968] và đóng vai trò như một chỉ báo về sự phát triển của ngôn ngữ, trở thành một trở ngại. khi nó được sử dụng trong các hệ thống lưu trữ và xử lý thông tin. Về vấn đề này, các ngôn ngữ nhân tạo được sử dụng trong AIS, được thiết kế đặc biệt để hình thành nội dung ngữ nghĩa chính của cơ sở thông tin và nhu cầu thông tin nhằm mục đích so sánh sau này.
...
Ngôn ngữ nhân tạo, trái ngược với ngôn ngữ tự nhiên có bản chất mơ hồ, là phương tiện giao tiếp và biểu đạt tư tưởng chính, là một ngôn ngữ chuyên biệt, mục đích chính của nó là loại bỏ sự mơ hồ của các từ trong ngôn ngữ tự nhiên và mọi thứ đặc trưng cho cảm xúc và thái độ đối với các đối tượng khác nhau. Ngôn ngữ nhân tạo chỉ nên thể hiện các đặc điểm khách quan của các đối tượng, các kết nối và mối quan hệ của chúng [Gorsky, 1962].
...
Các ngôn ngữ này chủ yếu bao gồm FL, cung cấp bản ghi nhỏ gọn, theo thuật toán nghiêm ngặt về nội dung tài liệu và yêu cầu trong IRS.
...
**Ngôn ngữ truy xuất thông tin** là ngôn ngữ nhân tạo được tạo ra nhằm thực hiện tốt hơn chức năng chính của ngôn ngữ - giao tiếp, tức là chức năng truyền tải thông tin. Trong ngôn ngữ thông tin, do tính rõ ràng của việc ghi thông tin, nên sự biến đổi trong cách chỉ định các khái niệm bị loại bỏ: tính đồng nghĩa (khi các từ có nghĩa giống nhau nhưng có âm thanh khác nhau) và tính đồng âm (khi các từ có cùng một âm thanh thể hiện ý nghĩa khác nhau) bị loại bỏ; Mỗi ý nghĩa của một biểu thức cụ thể được liên kết với một chuỗi ký hiệu. Nó hoạt động trong một bộ máy ngữ pháp đơn giản hơn (trong giới hạn - rõ ràng) so với ngôn ngữ tự nhiên. Nếu trong ngôn ngữ tự nhiên, các quy tắc được áp dụng trong đó cho phép có nhiều ngoại lệ khác nhau, thì trong ngôn ngữ thông tin, bất kỳ ngoại lệ nào đối với các quy tắc về nguyên tắc đều không thể xảy ra. Từ đồng nghĩa và đồng âm tìm thấy trong ngôn ngữ tự nhiên được đánh dấu bằng các dấu hiệu đặc biệt khi dịch sang ngôn ngữ thông tin. Ngôn ngữ thông tin, ví dụ, phân loại bằng sáng chế, hệ thống thập phân phổ quát, ngôn ngữ từ khóa, v.v.
...
Cơ sở để xây dựng hầu hết các ngôn ngữ thông tin là phương pháp logic-trực quan, về cơ bản tóm tắt như sau: khi nhìn vào một từ cụ thể, một người sẽ nhớ từ đó và mối quan hệ mà nó được kết nối với, sau đó cố gắng hiểu xem xét liệu kết nối ngữ nghĩa này hay kết nối ngữ nghĩa kia có thể hữu ích khi tìm kiếm hoặc trao đổi thông tin hay không.

---

Внутренняя структура языка характеризуется следующими составляющими — лексикой, грамматикой и словообразованием. 

Cấu trúc bên trong của một ngôn ngữ được đặc trưng bởi các thành phần sau - từ vựng, ngữ pháp và hình thành từ.

---

**Лексика** (или словарный состав) – это вся совокупность слов, входящих в состав языка. 

**Từ vựng** (hoặc từ vựng) là toàn bộ tập hợp các từ tạo nên một ngôn ngữ.
...
**Ngữ pháp** là một hệ thống các cách thức và phương tiện xây dựng từ và câu trong ngôn ngữ được đề cập. Ngữ pháp bao gồm hình thái và cú pháp.
...
**Hình thái** là tập hợp các phương pháp và phương tiện cấu tạo từ hoạt động trong một ngôn ngữ. Đơn vị nhỏ nhất không thể chia cắt của một hệ thống biểu đạt mà không làm mất đi chất lượng nhất định, tương quan trực tiếp với thành phần nội dung tương ứng của nó, được gọi là hình vị. Hình vị được chia thành ngữ pháp (phụ tố) và từ vựng (từ vị). Các phụ tố nhằm mục đích sửa đổi ý nghĩa của phần chính của từ (cơ sở). Từ vị là một hình vị gốc hoặc hình thái tạo từ, thể hiện ý nghĩa cơ bản của một từ.

---

**Синтаксис** – это совокупность действующих в языке способов и средств по-строения предложений. 

**Cú pháp** là tập hợp các phương pháp và phương tiện xây dựng câu hoạt động trong một ngôn ngữ.

---

**Словообразование** определяется как совокупность способов и средств образова-ния слов на базе уже существующих. 

**Hình thành từ** được định nghĩa là tập hợp các phương pháp và phương tiện hình thành từ trên cơ sở những phương pháp và phương tiện hình thành từ hiện có.
...
Các đối tượng và hiện tượng của hiện thực khách quan được kết nối với nhau bằng những mối quan hệ nhất định tồn tại bất kể cách giải thích ngôn ngữ của chúng. Những mối quan hệ này được xác định bởi chính các yếu tố logic chủ thể chứ không phải bởi bản thân các yếu tố ngôn ngữ (ngữ nghĩa) và thuộc phạm trù kết nối ngoài ngôn ngữ. Chính những kết nối dựa trên đặc điểm ngữ nghĩa này hay đặc điểm ngữ nghĩa khác đã giúp có thể thống nhất các từ thành các nhóm từ vựng-ngữ nghĩa, được gọi là mô hình, đồng thời nêu bật rõ ràng những đặc điểm đặc trưng của nhóm này.
...
Từ ví dụ trên, có thể thấy rằng các mối quan hệ mẫu mực trong từ vựng không chỉ có nhiều giai đoạn mà còn có nhiều chiều. Cùng một từ có thể đồng thời là thành viên của một số mô hình từ vựng-ngữ nghĩa, trong đó các từ đối lập với nhau theo ý nghĩa nào đó của một đặc điểm ngữ nghĩa nhất định (Hình 5.2).
...
**Mối quan hệ mô hình** (hoặc quan hệ phân tích, cơ bản) là các mối quan hệ logic tồn tại giữa các đơn vị từ vựng của một ngôn ngữ bất kể bối cảnh sử dụng cụ thể của chúng. Chúng ta có thể nói rằng các mối quan hệ mang tính mô hình xác định trước việc lựa chọn từ ngữ cho bất kỳ thông điệp nào, nhưng bản thân chúng có thể nằm ngoài ranh giới của nó.
...
Một loại mối quan hệ khác giữa các từ là mối quan hệ ngữ đoạn, hoạt động giữa các từ trong một thông điệp hoặc cụm từ cụ thể.
...
**Quan hệ cú pháp** (hoặc quan hệ văn bản, tổng hợp, cú pháp) là các kết nối giữa các đơn vị từ vựng của một ngôn ngữ, thể hiện các kết nối logic thực tế giữa các khái niệm tương ứng trong văn bản của thông điệp, từ đó phản ánh các mối quan hệ tình huống cụ thể giữa các đối tượng họ chỉ định và mô tả trong tin nhắn.
...
Hỗ trợ ngôn ngữ của hệ thống thông tin là một tập hợp các công cụ ngôn ngữ giúp trình bày thành phần thông tin của hệ thống thông tin ở các giai đoạn khác nhau của quá trình xử lý và tương tác nội bộ hệ thống với người dùng.
```
...
Theo đó, định nghĩa này giả định việc xác định hai khía cạnh quyết định lẫn nhau của việc sử dụng LO: sự thể hiện nội dung ngữ nghĩa của IR và sự thể hiện nhu cầu thông tin của người dùng.
...
Sơ đồ đề xuất không nhằm mục đích phân loại mà chỉ là một minh họa phản ánh sự phát triển và đặc điểm của việc sử dụng các phương tiện ngôn ngữ trong hệ thống thông tin: IPL - như một phương tiện thể hiện nội dung ngữ nghĩa của tài liệu và nhu cầu thông tin của người dùng ; SQL – như một công cụ quản lý dữ liệu; cấu trúc thuật ngữ - một mặt là mô hình dữ liệu và mặt khác là các hệ thống khái niệm được thể hiện bằng ngôn ngữ nhân tạo với từ vựng tự nhiên.
...
Nghĩa là, IPL là một ngôn ngữ nhân tạo, được thiết kế đặc biệt để thể hiện thuận tiện (con người) nội dung ngữ nghĩa chính của tài liệu và các yêu cầu nhằm mục đích so sánh tiếp theo của chúng (bởi hệ thống). ILP cung cấp bản ghi nhỏ gọn, theo thuật toán chặt chẽ, thân thiện với máy tính và con người về các khía cạnh quan trọng nhất của nội dung tài liệu và yêu cầu [Avetisyan, 1981].
...
Từ quan điểm coi ngôn ngữ như một mô hình phản ánh trạng thái và mối liên hệ của các đối tượng và hiện tượng trong thế giới thực, hệ hình của ngôn ngữ phản ánh sự hiện diện của các mối quan hệ nhất định diễn ra ở cấp độ được biểu đạt và/hoặc người biểu đạt [Skorokhodko, 1974]. Ví dụ, mối quan hệ đồng nghĩa (sự đồng nhất của những cái được biểu đạt dưới những cái được biểu đạt khác nhau) là một mối quan hệ nghịch lý của những cái được biểu đạt, trong khi mối quan hệ đồng âm (sự đồng nhất của những cái được biểu đạt dưới những cái được biểu đạt khác nhau) là một mối quan hệ nghịch biến của những cái được biểu đạt.
...
Các mối quan hệ mẫu mực của cái biểu đạt tương đối dễ dàng để hệ thống hóa, trong khi việc hệ thống hóa các mối quan hệ mẫu mực của những cái được biểu đạt là một nhiệm vụ khó khăn hơn nhiều. Sự khác biệt này rõ ràng là hệ quả của thực tế là những cái biểu đạt, với tư cách là những yếu tố của ngôn ngữ, có tính chất nhân tạo, đặc biệt tập trung vào việc đơn giản hóa giao tiếp, trong khi hệ hình học của những cái được biểu đạt có liên quan chặt chẽ đến việc mô hình hóa các yếu tố hoạt động trí tuệ của con người: sự hình thành trong tâm trí con người là những phản ánh chủ quan của những mối liên hệ hiện hữu khách quan giữa các sự vật, hiện tượng khác nhau của thế giới xung quanh. Ngoài bản thân các đối tượng và hiện tượng, “những người khởi xướng” các mối liên hệ (liên kết) đó cũng là những biểu hiện ngôn ngữ của các đối tượng và hiện tượng này. Những liên tưởng được hình thành trong tâm trí của nhiều cá nhân khác nhau được tinh chỉnh và sửa đổi trong quá trình nhận thức; những kết nối ngẫu nhiên được sàng lọc, biến mất và những kết nối phù hợp hơn với những kết nối hiện có một cách khách quan sẽ được củng cố, để sau này nhường chỗ cho những kết nối mới thậm chí còn phù hợp hơn. Nếu chúng ta tính đến ảnh hưởng của yếu tố chủ quan đến động lực của quá trình xuất hiện và phát triển của các hiệp hội đó, thì sẽ thấy rõ nhiệm vụ hệ thống hóa chính xác chúng trong một số lĩnh vực chủ đề nhất định khó khăn như thế nào. Tuy nhiên, dựa trên sự cần thiết thực tế, trong nhiều trường hợp, nên xác định một số loại hiệp hội nhất định tương đối ổn định và có thể hệ thống hóa được. Trước hết, điều này bao gồm các mối quan hệ gia đình (mối quan hệ phụ thuộc). Chính bản chất xuyên tình huống của những liên tưởng như vậy quyết định phần lớn tính hữu ích của việc ghi chúng vào từ điển tương ứng.
...
Ngữ đoạn thường gắn liền với khả năng tiềm tàng của ngôn ngữ, trong khi ngữ đoạn phản ánh động lực của các tình huống cụ thể trong lĩnh vực chủ đề.
...
Trong nhiệm vụ tìm kiếm, chúng ta có thể coi quan hệ hệ biến hóa là quan hệ giữa các từ được thay thế trong văn bản, còn quan hệ ngữ đoạn là quan hệ giữa các từ có thể kết hợp được. Và từ góc độ nội dung thông tin của văn bản, có thể nói rằng para-digmatics chủ yếu chứa đựng siêu thông tin (phản ánh cấu trúc của ngôn ngữ), trong khi các quan hệ ngữ đoạn (thông qua cú pháp) thể hiện một cách chi tiết ý nghĩa chính của văn bản. tài liệu, phân biệt nó với những tài liệu khác, kể cả những tài liệu được xây dựng chủ yếu bằng cách sử dụng cùng một từ vựng.
...
Đại diện chính của cấu trúc thuật ngữ mạng là từ điển đồng nghĩa.
...
Toàn bộ thế giới xung quanh có thể được coi là một tập hợp gồm hai yếu tố: đồ vật và mối quan hệ của chúng. Thế giới thực sự tồn tại này được phản ánh trong tâm trí con người dưới dạng các khái niệm liên kết với nhau, nghĩa là dưới dạng suy nghĩ trong đó chỉ những kết nối và đặc điểm thiết yếu của một đối tượng mới được ghi lại trong tâm trí.
...
Tất cả các khái niệm về ngôn ngữ tự nhiên dùng để mô tả thế giới xung quanh đều được đưa vào một từ điển đồng nghĩa phổ quát phản ánh toàn bộ vũ trụ tri thức. Từ điển đồng nghĩa như vậy là danh sách các khái niệm được thể hiện bằng ngôn ngữ tự nhiên, chỉ ra mối quan hệ giữa chúng.
...
Một từ điển đồng nghĩa chung có thể được chia thành các từ điển từ điển cụ thể bằng cách tách biệt một tập hợp các khái niệm đồng nhất theo cấp độ phân cấp của chúng hoặc bằng cách tách biệt các khái niệm có thể mô tả bất kỳ phần cụ thể nào của thế giới. Do đó, trên cơ sở một từ điển đồng nghĩa phổ quát, có thể biên soạn vô số từ điển đồng nghĩa cho các lĩnh vực kiến ​​thức khác nhau, cho các vấn đề và nhiệm vụ riêng lẻ.

---

Термин тезаурус достаточно древнего происхождения. 

Thuật ngữ từ điển đồng nghĩa có nguồn gốc khá cổ xưa.

---

Впервые его применил в значении, близком сегодняшнему, еще в тринадцатом столетии Брутто Латини в заголовке своего труда – систематизированной энциклопедии «Книга о сокровище». Особенно большую известность получил тезаурус, составленный в 1852 г. англичанином Роджетом «для облегчения выражения мыслей и помощи при написании сочинений» [3]. 

Nó lần đầu tiên được sử dụng theo nghĩa gần với nghĩa ngày nay vào thế kỷ thứ mười ba bởi Brutto Latini trong tựa đề tác phẩm của ông, bộ bách khoa toàn thư có hệ thống “Cuốn sách về kho báu”. Đặc biệt nổi tiếng là từ điển đồng nghĩa được biên soạn vào năm 1852 bởi người Anh Roget “để tạo điều kiện thuận lợi cho việc bày tỏ suy nghĩ và hỗ trợ viết bài luận” [3].

---

Тезаурус может быть представлен как семантическая сеть, в которой понятия связаны регулярными и устойчивыми семантическими отношениями –  иерархическими (например, род-вид, целоечасть), ассоциативными, а также отношениями эквивалентности. 

Một từ điển đồng nghĩa có thể được biểu diễn dưới dạng một mạng ngữ nghĩa trong đó các khái niệm được kết nối bằng các mối quan hệ ngữ nghĩa thường xuyên và ổn định - phân cấp (ví dụ: giống-loài, số nguyên), quan hệ kết hợp cũng như quan hệ tương đương.

---

При этом отдельное понятие определенной области знаний в тезаурусе представлено словом или словосочетанием, соотносящимся с другими словами и словосочетаниями и образующим вместе с ними замкнутую систему [3]. 

Trong trường hợp này, một khái niệm riêng biệt về một lĩnh vực kiến ​​thức nhất định trong từ điển đồng nghĩa được thể hiện bằng một từ hoặc cụm từ tương quan với các từ và cụm từ khác và cùng với chúng tạo thành một hệ thống khép kín [3].
...
Các mối quan hệ phân cấp trong từ điển đồng nghĩa thể hiện sự phân loại dựa trên các từ của ngôn ngữ tự nhiên chứ không phải trên các danh mục trừu tượng, do đó cấu trúc chính xác của cây bị vi phạm - cùng một thuật ngữ có thể có một số “mẹ” - các thuật ngữ cao hơn ở cấp độ trước đó.

---

Например, в Тезаурусе по информатике [11] словосочетание Автоматизированная обработка информации имеет два вышестоящих родителя: Автоматизированная обработка и Обработка информации, а слово Буквы – целых три родителя: алфавиты, символы, буквенно-цифровая информация. 

Ví dụ, trong Từ điển khoa học máy tính [11], cụm từ Automated informationprocess có hai cha mẹ cao hơn: Automated Treatment và Information Treatment, và từ Letters có ba cha mẹ: bảng chữ cái, ký hiệu, thông tin chữ và số.
...
Từ điển đồng nghĩa, hiển thị các mối quan hệ ngữ nghĩa có thể có của các thuật ngữ được trình bày trong cơ sở dữ liệu, là một công cụ từ vựng lý tưởng cho các hệ thống truy xuất thông tin, nhờ đó bạn có thể tìm thấy từ vựng cần thiết để soạn các truy vấn hoặc sửa đổi chúng nhằm đạt được các chỉ số hiệu suất tìm kiếm tốt nhất.
...
Từ điển tra cứu thông tin. Từ điển tra cứu thông tin cho phép chúng ta giải quyết vấn đề tương quan:

- thuật ngữ của tác giả (các khái niệm và từ ngữ trong ngôn ngữ tự nhiên mà tác giả sử dụng để biểu thị các khái niệm này);
- thuật ngữ hệ thống (các khái niệm và thuật ngữ được sử dụng để thể hiện các khái niệm này khi nhập tài liệu vào IPS);
- thuật ngữ của người tiêu dùng (các khái niệm và thuật ngữ mà người tiêu dùng sử dụng để thể hiện các khái niệm này khi hình thành các yêu cầu).

## 20.	Назначение и определение онтологии. Виды отношений в онтологии.

### Назначение и определение онтологии
...
Một trong những lĩnh vực đầy hứa hẹn trong lĩnh vực hình thức hóa kiến ​​thức, giúp có thể sử dụng kiến ​​thức tích lũy để xử lý máy tính, là ontology.
...
**Ontology** là một tập hợp các định nghĩa (bằng ngôn ngữ hình thức) của một phần kiến ​​thức khai báo, nhằm mục đích sử dụng lại chung giữa những người dùng khác nhau. Ontology giới thiệu các thuật ngữ, loại và mối quan hệ (tiên đề) mô tả một phần kiến ​​thức [2]. Bằng cách này, ontology xác định một từ vựng chung cho các chuyên gia cần chia sẻ thông tin trong một lĩnh vực chủ đề.
...
Khái niệm ontology được sử dụng tích cực trong khoa học máy tính và trí tuệ nhân tạo. Thuật ngữ này xuất phát từ triết học, nơi nó biểu thị một phần của siêu hình học - học thuyết về vạn vật, về những phạm trù triết học tổng quát nhất của nó, chẳng hạn như bản thể, bản chất, nguyên nhân, hành động, hiện tượng. Đồng thời, bản thể học với tư cách là một khoa học khẳng định có thể đưa ra lời giải thích đầy đủ về nguyên nhân của mọi hiện tượng [4; 33].
...
Các ontology biểu diễn các khái niệm ở dạng thích hợp cho quá trình xử lý của máy. Các ontology thường được sử dụng như một trung gian giữa người dùng và hệ thống thông tin: với sự trợ giúp của chúng, các thỏa thuận về thuật ngữ có thể được chính thức hóa.

---

По степени зависимости от конкретной задачи или предметной области обычно различают следующие онтологии. 

Dựa trên mức độ phụ thuộc vào một nhiệm vụ hoặc lĩnh vực chủ đề cụ thể, các ontology sau đây thường được phân biệt.

---

**Онтологии верхнего уровня** – описывают наиболее общие, независимые от конкретной проблемы или области концепты (пространство, время, материя, объект, событие, действие и т. д.), которые могут быть унифицированы для больших сообществ пользователей. 

**Bản thể luận cấp cao nhất** - mô tả các khái niệm chung nhất (không gian, thời gian, vật chất, đối tượng, sự kiện, hành động, v.v.) độc lập với một vấn đề hoặc lĩnh vực cụ thể, có thể được thống nhất cho cộng đồng người dùng lớn.

---

**Онтологии, ориентированные на предметную область** – стандартные онтологии, которые могут использоваться экспертами для совместной информационной деятельности в своей области. 

**Bản thể luận dành riêng cho miền** là các bản thể tiêu chuẩn có thể được các chuyên gia sử dụng cho các hoạt động thông tin hợp tác trong lĩnh vực của họ.

---

**Онтологии, ориентированные на задачу** – онтологии, используемые при выполнении конкретной задачи. Они отражают специфику решения задачи, но могут также содержать некоторые общие термины. 

**Bản thể luận hướng nhiệm vụ** là các bản thể luận được sử dụng để thực hiện một tác vụ cụ thể. Chúng phản ánh những chi tiết cụ thể của việc giải quyết vấn đề nhưng cũng có thể chứa đựng một số thuật ngữ chung.
...
**Bản thể học ứng dụng** – mô tả các khái niệm có thể liên quan đến cả bản thể học của nhiệm vụ và bản thể luận của SbA. Một ví dụ là bản thể luận của ô tô, vật liệu xây dựng và công nghệ máy tính. Một ontology ứng dụng khái quát hóa các khái niệm được sử dụng trong một số bài toán SbA, trừu tượng hóa từ chính các bài toán đó (ví dụ: ontology ô tô độc lập với bất kỳ đặc điểm nào của các nhãn hiệu ô tô cụ thể).

### Виды отношений в онтологии

При создании онтологии предметной области выделяются отношения, которые необходимо использовать для задания связей между объектами. Далее приводится краткий обзор отношений в существующих онтологиях. Набор этих отношений призван обеспечить эффективную работу в информационно-поисковых приложениях. 

Khi tạo một ontology miền, các mối quan hệ được xác định phải được sử dụng để xác định các kết nối giữa các đối tượng. Sau đây là tổng quan ngắn gọn về các mối quan hệ trong các ontology hiện có. Tập hợp các mối quan hệ này được thiết kế để đảm bảo hoạt động hiệu quả trong các ứng dụng truy xuất thông tin.

---

**Отношения иерархии** делятся на три подвида. 

**Mối quan hệ phân cấp** được chia thành ba loại phụ.

---

1. Родовидовое или внутрикатегориальное отношение *род $\leftrightarrow$ вид*. 
...
- В имеет следующие виды: А1, А2, …, АN ;  
- к видам В относятся А1, А2, …, АN . 

1. Mối quan hệ chung hoặc nội loại *chi $\leftrightarrow$ loài*.

Cấu trúc câu cơ bản tìm kiếm khái niệm chung B và khái niệm cụ thể A:

- A ám chỉ B;
- giống A là B;
- A thuộc lớp/gia đình B.
- B có các loại: A1, A2, ..., AN;
- Loại B gồm A1, A2,..., AN.

---

2. Отношение *признак $\leftrightarrow$ значение* признака или отношение типизация-конкретизация. Здесь признак или тип – это категория, а значение – это имя конкретной категориальной формы. 
...
2. Thuộc tính quan hệ *thuộc tính $\leftrightarrow$ value* hoặc quan hệ đặc tả kiểu gõ. Ở đây thuộc tính hoặc loại là một danh mục và giá trị là tên của một dạng phân loại cụ thể.

Cấu trúc cơ bản của câu tìm kiếm sử dụng quan hệ, nếu A là phạm trù khái niệm, B là tên phạm trù:
...
3. Отношение *инвариант $\leftrightarrow$ вариант*. В этом отношении инвариант – это неизменная структурная единица языка, а вариант – разновидность структурной единицы языка. 

Основные конструкции предложений для поиска с использованием отношения для понятия инварианта А и варианта В:  

- к вариантам А относятся В1, В2, …, BN ;  
- инвариантом В является А. 

3. Quan hệ *biến thể $\leftrightarrow$ bất biến*. Về vấn đề này, bất biến là một đơn vị cấu trúc không thay đổi của ngôn ngữ, và một biến thể là một biến thể của một đơn vị cấu trúc ngôn ngữ.

Các cấu trúc cơ bản của câu tìm kiếm sử dụng quan hệ cho khái niệm bất biến A và phương án B:

- Phương án A gồm B1, B2,..., BN;
- bất biến của B là A.
...
**Mối quan hệ tổng hợp** được chia thành bốn loại phụ.

---

1. Отношение *целое $\leftrightarrow$ часть* (компонент). Целое в отношении – то, что перестает существовать, если отнять любую часть, а часть – то, без чего целого не существует.  

Для поиска используются следующие конструкции (целое А – часть В): 

- В входит в состав А;
- В составляет часть А;  
- В является частью;  
...
1. Quan hệ *phần nguyên $\leftrightarrow$* (thành phần). Tổng thể trong mối quan hệ là cái gì đó sẽ không còn tồn tại nếu một bộ phận nào đó bị lấy đi, và một bộ phận là cái mà không có nó thì tổng thể không tồn tại.

Các cấu trúc sau đây được sử dụng để tìm kiếm (toàn bộ phần A – phần B):

- B là một phần của A;
- B là một phần của A;
- B là một phần;
- B là một phần tử của A;
- A gồm B1, B2, ..., BN;
- A bao gồm B là một phần;
- A bao gồm B là một phần;
- A có các bộ phận/phần tử B1, B2, ..., BN.

---

2. Отношение *объект $\leftrightarrow$ пространство* реализации объекта. 
...
2. Triển khai đối tượng *object $\leftrightarrow$space*.

Không gian hiện thực hóa là không gian nơi đối tượng A thể hiện các tính chất và chức năng của nó.
...
3. Отношение *объект $\leftrightarrow$ свойство/признак*. Свойство – это то, что присуще объекту, что отличает его от других. Свойства делятся на существенные и несущественные. 

Основные выражения для поиска следующие:  

- А обладает свойством В,  
- А имеет В существенным признаком;  
- А характеризуется наличием В;  
- для А характерно В. 

3. Quan hệ *đối tượng $\leftrightarrow$ thuộc tính/tính năng*. Thuộc tính là thứ vốn có của một đối tượng, giúp phân biệt nó với những đối tượng khác. Thuộc tính được chia thành thiết yếu và không thiết yếu.

Các biểu thức tìm kiếm chính như sau:

- A có tài sản B,
- A có B là đặc điểm cơ bản;
- A được đặc trưng bởi sự có mặt của B;
- A có đặc điểm là B.

---

4. Отношение *уровень $\leftrightarrow$ единица* уровня. Выделяют такие составляющие, как уровень, единица уровня, тип структуры. 

Для поиска используются следующие выражения: 

- А принадлежит уровню В;  
- А - единица уровня В;  
- А рассматривается на уровне В. 

4. Tỷ lệ *cấp $\leftrightarrow$ đơn vị* cấp. Có các thành phần như cấp độ, đơn vị cấp độ, loại cấu trúc.

Các biểu thức sau đây được sử dụng để tìm kiếm:

- A thuộc cấp độ B;
- A - đơn vị cấp B;
- A được coi là ở cấp độ B.
...
**Quan hệ dấu hiệu học** nhằm thể hiện sự tương ứng giữa các khái niệm về hệ thống ký hiệu. Thông qua các mối quan hệ như vậy, có thể tạo ra các hệ thống phân cấp khái niệm về hệ thống ký hiệu, với mỗi cấp độ của hệ thống phân cấp tương ứng với một ngôn ngữ kim loại. Các loại quan hệ ký hiệu học:

---

1. Отношение *термин $\leftrightarrow$ способ выражения*. Отражает фундаментальные свойства языка как системы знаков, имеющей план выражения и план содержания. Как знаковая система, предназначенная для коммуникации, язык обладает совокупностью средств выражения самых разнообразных значений. Отсюда следует, что в языке должна быть терминология, относящаяся к формальной стороне языка, и терминология, называющая значения и функции. В данном отношении осуществляется связь двух языковых объектов. 

Диагностирующие выражения: 

- А обычно выражает В; 
- А используется для выражения В; 
- А является В.

1. Mối quan hệ *thuật ngữ $\leftrightarrow$ cách diễn đạt*. Phản ánh các đặc tính cơ bản của ngôn ngữ như một hệ thống các dấu hiệu có mặt phẳng biểu đạt và mặt phẳng nội dung. Là một hệ thống ký hiệu nhằm mục đích giao tiếp, ngôn ngữ có một tập hợp các phương tiện thể hiện nhiều ý nghĩa khác nhau. Theo đó, ngôn ngữ phải có thuật ngữ liên quan đến khía cạnh hình thức của ngôn ngữ cũng như ý nghĩa và chức năng đặt tên của thuật ngữ. Về vấn đề này, một kết nối được thực hiện giữa hai đối tượng ngôn ngữ.

Biểu diễn chẩn đoán:

- A thường diễn đạt B;
- A dùng để diễn đạt B;
- A là B.

---

2. Отношение *термин $\leftrightarrow$ способ представления*. Фиксирует связь языкового объекта и его представления в модельном языке лингвистики (метаязыке), где ненаблюдаемый теоретический языковый объект может получить наглядный аналог во фрагменте или элементе некоторой модельной записи. Диагностирующие выражения:  

- А обычно представляется посредством В;  
- А используется для представления В;  
- А используется с помощью В. 

2. Quan hệ *thuật ngữ $\leftrightarrow$ cách biểu diễn*. Khắc phục kết nối giữa một đối tượng ngôn ngữ và cách biểu diễn của nó bằng ngôn ngữ mô hình của ngôn ngữ học (ngôn ngữ kim loại), trong đó một đối tượng ngôn ngữ lý thuyết không thể quan sát được có thể nhận được hình ảnh tương tự trong một đoạn hoặc thành phần của một số bản ghi mô hình. Biểu hiện chẩn đoán:

- A thường được đại diện bởi B;
- A dùng để đại diện cho B;
- A được dùng với B.

---

3. Отношение термин одного метаязыка $\leftrightarrow$ термин другого метаязыка. Позволяет установить соответствие между двумя знаковыми системами как в одной предметной области, имеющей разные уровни представления знаний, так и между смежными предметными областями. 
...
3. Quan hệ là thuật ngữ của một ngôn ngữ kim loại $\leftrightarrow$ một thuật ngữ của ngôn ngữ kim loại khác. Cho phép bạn thiết lập sự tương ứng giữa hai hệ thống ký hiệu trong cùng một lĩnh vực chủ đề, có mức độ biểu diễn kiến ​​thức khác nhau và giữa các lĩnh vực chủ đề liền kề.

Biểu hiện chẩn đoán:

- A được trình bày là/là B;
- A được đại diện bởi B;
- cách biểu diễn A là B.
...
**Các quan hệ chức năng** – các quan hệ thuộc phạm vi thủ tục là một “Hoạt động” vị từ nhiều vị trí, trong đó các đối số (vị trí) sau được phân biệt:

- A: đối tượng hoạt động;
- B: công cụ hoặc phương pháp/phương pháp/thuật toán để thực hiện một thao tác;
- C: đối tượng ban đầu hoặc dữ liệu ban đầu;
- D: đối tượng cuối cùng hoặc kết quả/đầu ra;
- E: sự kiện kích hoạt thao tác.
...
Chủ thể của hoạt động có thể là con người hoặc thiết bị. Biểu thức chính để xác định chủ đề của hoạt động:
...
Đối tượng ban đầu (dữ liệu ban đầu) là đối tượng mà thao tác được thực hiện trên đó. Biểu thức để xác định đối tượng ban đầu:

- A được thực hiện trên B;
- A áp dụng cho B;
- A thay đổi B.

---

Конечный объект или результат/выходные данные – это объект, являющийся конечным результатом выполнения операции. 


Đối tượng cuối cùng hoặc kết quả/đầu ra là đối tượng là kết quả cuối cùng của một thao tác.

---

Выражения для выявления конечного объекта:  
...
Biểu thức để xác định đối tượng cuối cùng:

- kết quả là A dẫn đến B;
- do A mà B được hình thành;
- A dẫn đến B;
- A biến B1 thành B2.

---

В [30] предлагается следующая типология отношений (связей): 
...
Loại hình mối quan hệ (kết nối) sau đây được đề xuất trong [30]:

- các mối quan hệ phân loại thể hiện mối quan hệ “là một loài” hoặc mối quan hệ “chung/cụ thể”;
- các kết nối thành phần thể hiện mối quan hệ “là một phần” hoặc “tập hợp các đối tượng với nhau”;
- kết nối tôpô, phản ánh cách các thành phần (thành phần) khác nhau của hệ thống được kết nối với nhau thông qua các kết nối nhất định hoặc hiển thị “đường dẫn” tương tác vật lý giữa các thành phần.

---

Каждый из таких типов связей представлен в конкретных онтологиях множеством вариантов. 

Mỗi loại kết nối này được thể hiện trong các ontology cụ thể bằng nhiều tùy chọn.

---

К наиболее типичным таксономическим отношениям относятся отношения, ставящие две сущности в зависимость «частноеобщее», и обозначаемые «является потомком», «является подклассом», «является представителем». 

Các mối quan hệ phân loại điển hình nhất bao gồm các mối quan hệ đặt hai thực thể vào một mối quan hệ “chung cụ thể” và được biểu thị là “là con cháu”, “là lớp con”, “là đại diện”.

---

К композиционным связям в искусственном интеллекте и концептуальном моделировании относят различные типы отношений «часть-целое»: «компонент-объект», «вещество-ингредиент», «член из набора», «порция массы или большого количества», «место в области», «фаза, шаг-процесс». 

Các mối quan hệ thành phần trong trí tuệ nhân tạo và mô hình hóa khái niệm bao gồm nhiều loại mối quan hệ “bộ phận-toàn bộ”: “thành phần-đối tượng”, “chất-thành phần”, “thành viên của một tập hợp”, “phần khối lượng hoặc số lượng lớn”, “đặt trong khu vực”, “giai đoạn, quá trình từng bước”.

---

Топологическими связями являются следующие связи: 

- связь объекта и свойства: сущность «Имеет атрибутом» свойство; 
...
Kết nối tôpô là các kết nối sau:

- kết nối giữa một đối tượng và một thuộc tính: thực thể “Có thuộc tính” của một thuộc tính;
- kết nối của thực thể với quy trình và kết nối của thực thể với thực thể thông qua quy trình: “Thực thể hỗ trợ quá trình”, “Thực thể là công cụ của quy trình”, “Thực thể tham gia vào quá trình”, “Thực thể thực hiện quá trình” , “Thực thể kiểm soát quá trình”, v.v.;
- mối quan hệ nhân quả: “Một quá trình ảnh hưởng đến sự đi qua của một quá trình khác” (ví dụ, ngăn chặn, bảo vệ khỏi), “Quá trình này ảnh hưởng đến bản chất”, “Quá trình này gây ra một quá trình khác”, v.v.;
- kết nối tạm thời (hoặc kết nối của các thực thể xảy ra trong thời gian): “Một quy trình được kết nối kịp thời với một quy trình khác”, “Một khoảng thời gian là một phần của một quy trình khác”, “Một khoảng thời gian được kết nối với một khoảng thời gian khác”, “Một quy trình là một phần của Quy trình khác”;
- kết nối không gian: “Một thực thể nằm một phần trong một thực thể khác”, “Một thực thể lấp đầy một thực thể khác”, “Một thực thể là một vật mang (chứa bên trong nó) một quá trình”;
- các mối liên hệ sinh học liên quan: “Sinh vật có Sinh vật là cha mẹ”, “Sinh vật có Sinh vật là con cháu”, “Sinh vật có Sinh vật là anh/chị em”.
- Các kết nối “tinh thần”: “Một người sở hữu một cái gì đó”, “Một người là công dân của một cái gì đó”, “Thực thể là quê hương của Sinh vật”.
- kết nối mục tiêu: “Bản chất có mục tiêu trừu tượng”, “Bản chất là kết quả, là sản phẩm của Quá trình”, v.v.
...
Trong hình. Hình 4.3 thể hiện một phần ontology về khoa học tự nhiên và công nghệ ứng dụng trong lĩnh vực truy xuất thông tin [8].

## 21.	Локальные и глобальные компьютерные сети.

## 22.	Web-технология. Схема организации доступа к Web-страницам.

## 23.	Типология и структура распределенных ИР. 

## 24.	Поисковые системы в Internet. Назначение, область применения.

Рассматривая в предыдущих главах технологии и средства информационного поиска, мы не акцентировали внимание на организационно-физических аспектах ИР и доступа к ним, тем самым показывая, что принципы информационного поиска и архитектура ИС имеет универсальный характер.  

Xem xét các công nghệ và công cụ truy xuất thông tin trong các chương trước, chúng tôi đã không tập trung vào các khía cạnh tổ chức và vật lý của việc truy xuất thông tin và truy cập chúng, từ đó cho thấy rằng các nguyên tắc truy xuất thông tin và kiến ​​trúc truy xuất thông tin là phổ biến.
...
AIPS thực sự khác biệt khá đáng kể về khả năng của chúng (ít nhất là đối với người dùng). Điều này không phải do quyết định của một số nhà phát triển nhất định mà do nhiều yếu tố, ở mức độ này hay mức độ khác, hạn chế hoặc thậm chí loại trừ một số chức năng. Các yếu tố đó, ví dụ, mục đích và phạm vi ứng dụng, quy mô và cường độ sử dụng công nghệ thông tin, bản chất của việc phân phối các thành phần thông tin (đối với hệ thống mạng), loại thông tin, nguồn và phương thức bổ sung, mức độ chuyên nghiệp mong đợi của người tiêu dùng, v.v.
...
Theo kiến ​​trúc xác định tính khả dụng vật lý của tài nguyên, hệ thống truy xuất thông tin (bao gồm cả máy Internet) có thể được chia thành các lớp sau:

- hệ thống cục bộ – dữ liệu được bản địa hóa và quá trình xử lý chúng;
- phân phối một phần – xử lý cục bộ dữ liệu phân tán;
- các hệ thống phân tán đầy đủ trong đó các nguyên tắc tính toán phân tán và lưu trữ dữ liệu phân tán được thực hiện.
...
Hệ thống cục bộ cung cấp cho người dùng từ xa quyền truy cập vào các tài nguyên nằm trên máy chủ tìm kiếm. Trong hầu hết các trường hợp, các hệ thống này có chức năng tương đương với các hệ thống cục bộ, chẳng hạn như các hệ thống trên phương tiện CD-ROM.

---

Ко второму типу относятся системы, использующие данные, которые находятся на Web-серверах, в качестве распределенных первичных ИР; вторичные и индексные данные сосредоточены на поисковом сервере, осуществляющем обслуживание пользователей. Это такие системы, как AltraVista, Google, Yandex и пр. 

Loại thứ hai bao gồm các hệ thống sử dụng dữ liệu nằm trên máy chủ Web làm IR chính được phân phối; Dữ liệu thứ cấp và chỉ mục được tập trung trên máy chủ tìm kiếm phục vụ người dùng. Đây là những hệ thống như AltraVista, Google, Yandex, v.v.
...
Loại thứ ba bao gồm các hệ thống trong đó quy trình tìm kiếm được triển khai trên một tập hợp các máy chủ được phân phối qua mạng, các máy chủ này sẽ thăm dò lẫn nhau khi xử lý yêu cầu, đồng thời dữ liệu tìm kiếm ban đầu và trung gian cũng được phân phối.
...
Về mặt chủ đề và phổ loại, IR có thể đồng nhất (có chủ đề được xác định rõ ràng và làm việc với các tài liệu thuộc loại và thành phần nhất định) và không đồng nhất (đa chủ đề và không có yêu cầu về thành phần và hình thức tài liệu).
...
Theo phương pháp hình thành, IR được chia thành những IR sử dụng các nguồn được xác định trước, ví dụ, các ấn phẩm của các nhà xuất bản xem xét tài liệu và những IR sử dụng tất cả các tài liệu có sẵn miễn phí. Ví dụ ở đây tương ứng là cơ sở dữ liệu về thông tin khoa học và các công cụ tìm kiếm trên Internet lập chỉ mục các trang HTML mở.

---

Если рассматривать электронные библиотеки в этом контексте, то можно заметить, что в качестве компонентов здесь выступают электронные каталоги (библиографические и реферативные базы данных), полнотекстовые массивы (электронные журналы, фактографические базы данных, хранилища электронных копий источников в том или ином виде и т.д.), справочно-нормативные файлы (рубрикаторы, тезаурусы, авторские, предметные, географические и другие указатели), возможно связанные между собой ссылками, указателями хранения или условиями поиска, хотя уже по своей сути эти компоненты всегда были и будут связаны, по крайней мере, на концептуальном уровне. Например, записи электронных каталогов содержат указания местоположения книг, а справочно-нормативные файлы традиционно используются в качестве «точек входа» в библиографические и реферативные базы данных. С появлением технических возможностей создания полнотекстовых баз данных справочно-поисковый аппарат и собственно массив информации технологически становятся единым целым, а на первый план выходит задача организации такой взаимосвязи, чтобы переход по ссылке от компонентов одного уровня к компонентам другого воспринимался пользователем как простейший одномоментный процесс, подобно перевороту страницы книги. 

Nếu xem xét thư viện điện tử trong bối cảnh này, chúng ta có thể thấy rằng các thành phần ở đây là danh mục điện tử (cơ sở dữ liệu thư mục và trừu tượng), mảng toàn văn (tạp chí điện tử, cơ sở dữ liệu thực tế, kho lưu trữ bản sao điện tử của các nguồn ở dạng này hay dạng khác, v.v.). ..), v.v.), các tệp tham chiếu và quy phạm (bộ phân loại, từ điển đồng nghĩa, bản quyền, chủ đề, địa lý và các chỉ mục khác), có thể được kết nối với nhau bằng các liên kết, chỉ mục lưu trữ hoặc điều kiện tìm kiếm, mặc dù về bản chất đã có. những thành phần này đã và sẽ luôn được kết nối với nhau, ít nhất là ở cấp độ khái niệm. Ví dụ, biểu ghi danh mục điện tử chứa các chỉ dẫn về vị trí của sách và các tệp tham chiếu theo truyền thống được sử dụng làm “điểm truy cập” vào cơ sở dữ liệu thư mục và trừu tượng. Với sự ra đời của các khả năng kỹ thuật để tạo cơ sở dữ liệu toàn văn bản, công cụ tham chiếu và tìm kiếm cũng như mảng thông tin về mặt công nghệ đang trở thành một tổng thể duy nhất và nhiệm vụ tổ chức một mối quan hệ như vậy trở nên quan trọng để người dùng nhận thức được quá trình chuyển đổi. bằng cách liên kết từ các thành phần của cấp độ này tới các thành phần của cấp độ khác dưới dạng quy trình một bước đơn giản, giống như lật trang sách.

---

С организационной же точки зрения ЭБ помимо справочнопоискового сервиса обычно включает службу электронной доставки, обеспечивающую нахождение (или изготовление) и предоставление копий документов. 

Từ quan điểm tổ chức, ngoài dịch vụ tìm kiếm tài liệu tham khảo, thư viện điện tử thường bao gồm dịch vụ chuyển phát điện tử đảm bảo việc tìm kiếm (hoặc sản xuất) và cung cấp bản sao tài liệu.
...
Xét về bản chất, hình thức trình bày thông tin (và theo đó là tính logic của tổ chức tìm kiếm), kiến ​​trúc của hệ thống công nghệ thông tin bao gồm ba cấp độ: cấp độ tài liệu thực tế (toàn văn), cấp độ của hình ảnh tìm kiếm và mức độ siêu thông tin. Bản chất và logic của mối tương quan giữa các yếu tố thông tin ở cấp độ cá nhân được phản ánh trong sơ đồ trong Hình 2. 8.1, trong đó các ví dụ điển hình cho hệ thống thông tin tự động hoặc truyền thống được đưa ra trong ngoặc đơn.
...
Mối quan hệ giữa các thành phần ở các cấp độ khác nhau có thể được thực hiện cho cả các thành phần nói chung và các phần tử của chúng. Ví dụ, một hình minh họa là một kết nối như “bản ghi thư mục của danh mục điện tử - bản ghi của cơ sở dữ liệu toàn văn bản” hoặc “bản ghi thư mục - bản sao số hóa của một nguồn (hình ảnh)”. Một loại khác (ở cấp độ phần tử) có thể bao gồm các kết nối như “tham chiếu bài viết – biểu ghi thư mục” hoặc “đoạn biểu ghi thư mục – bản ghi cơ sở dữ liệu quy chuẩn”, v.v. Như người ta nói, mọi thứ trên thế giới này đều có mối liên hệ với nhau. Tuy nhiên, đôi khi rất khó diễn đạt mối quan hệ này bằng lời nói hoặc thuật toán.
...
Coi sơ đồ này như một “công nghệ” tìm kiếm, có thể thấy rằng các liên kết khá dễ nhận biết và thể hiện các quy tắc và kỹ thuật truyền thống để tìm kiếm thông tin trong thư viện “giấy”, khi tìm kiếm bắt đầu bằng sơ đồ phân loại hoặc chỉ mục, sau đó thông qua thẻ thư mục. đến nguồn ban đầu, trong đó, sử dụng các tài liệu tham khảo và chỉ mục bài viết, một lần nữa tiếp tục từ cấp độ siêu thông tin.
...
Với việc áp dụng rộng rãi các mạng viễn thông và một số tiêu chuẩn hóa cách trình bày dữ liệu trên Internet, nhiệm vụ kết nối càng trở nên phức tạp hơn. Việc giải quyết nó bằng cách tạo các kết nối tĩnh trên thực tế là không thể, ngay cả khi tất cả các thành phần đều có mã định danh duy nhất của riêng chúng và một vị trí không thể lay chuyển trong không gian thông tin (điều này thường không thể đạt được ngay cả đối với các mảng cục bộ). Chúng ta có thể nói gì về những đối tượng thông tin xuất hiện trên nhiều trang Internet. Bất kỳ sự thay đổi nào về vị trí của đối tượng thông tin đều kéo theo sự xuất hiện của các kết nối “sai” trong các thư viện điện tử phân tán. Và số lượng kết nối này tăng lên theo thời gian. Vì vậy, các kết nối tĩnh được thay thế bằng các kết nối động. Điểm đặc biệt của chúng là chúng được tạo theo chương trình, theo các thuật toán được xác định trước trong quá trình truy cập vào đối tượng. Vì vậy, có thể liên kết các đối tượng thông tin nhưng phải đảm bảo đủ độ chắc chắn (đặc tả) của các phần tử.
...
Các kết nối nội bộ có thể được xây dựng trên các số nhận dạng như ISBN và ISSN đã được sử dụng từ lâu hoặc DOI (Số nhận dạng đối tượng kỹ thuật số) mới xuất hiện tương đối gần đây. Trong trường hợp thiếu số nhận dạng như vậy (và những trường hợp như vậy chiếm đa số), một giải pháp có thể là tạo liên kết động. Cơ sở để xây dựng các mã định danh ở đây có thể là các phần tử duy nhất của một bản ghi hoặc các phần tử tích chập của chúng.
...
Ngoài ra, các phần của thành phần mô tả thư mục, được tổ chức, ví dụ, dưới dạng chỉ mục tìm kiếm, có thể đóng vai trò là mã định danh được sử dụng để thiết lập các liên kết hoạt động. Bằng cách này, bạn có thể liên kết, ví dụ, các thành phần của tệp tham chiếu và mảng các biểu ghi thư mục. Tất nhiên, điều này chỉ có thể thực hiện được với cấu trúc khá chặt chẽ của các thành phần cơ sở dữ liệu và việc sử dụng các thuật toán tích chập cho phép tỷ lệ trùng lặp tối thiểu.
...
Chúng ta hãy lưu ý để kết luận rằng chính những khác biệt về kiến ​​trúc, chiến lược mua lại và tổ chức truy cập cuối cùng sẽ xác định không chỉ chức năng của các công cụ tìm kiếm cho một IR cụ thể mà còn cả phạm vi người dùng tiềm năng cũng như tính hiệu quả của các nhiệm vụ họ giải quyết.
