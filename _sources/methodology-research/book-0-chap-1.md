...
Наблюдение должно удовлетворять определенным требованиям:  – наблюдение должно проводиться для четко поставленной задачи;  – в первую очередь при наблюдении должны рассматриваться интересующие стороны явления;  – наблюдение должно быть активным;  – при наблюдении необходимо искать определенные черты явления. 

Việc quan sát phải đáp ứng các yêu cầu nhất định: – việc quan sát phải được thực hiện cho một nhiệm vụ được xác định rõ ràng; – trước hết, khi quan sát, cần xem xét các khía cạnh quan tâm của hiện tượng; – quan sát phải tích cực; – khi quan sát cần tìm những đặc điểm nhất định của hiện tượng.

---

Любое научное наблюдение способствует выявлению дополнительных факторов и закономерностей развития наблюдаемых явлений или процессов и накоплению нового эмпирического знания.  

Bất kỳ quan sát khoa học nào cũng giúp xác định các yếu tố và mô hình phát triển bổ sung của các hiện tượng hoặc quá trình được quan sát cũng như sự tích lũy kiến ​​​​thức thực nghiệm mới.

---

Наблюдение должно вестись по плану и подчиняться определенной тактике. В некоторых случаях результаты наблюдения дают не только первичную информацию об объекте, но и при ее правильном объяснении могут привести к крупным научным открытиям. В связи с этим наблюдаемость является одним из важных качеств исследования. 

Việc quan sát phải được thực hiện theo kế hoạch và tuân theo các chiến thuật nhất định. Trong một số trường hợp, kết quả quan sát không chỉ cung cấp thông tin cơ bản về một vật thể mà nếu được giải thích hợp lý còn có thể dẫn đến những khám phá khoa học quan trọng. Về vấn đề này, khả năng quan sát là một trong những phẩm chất quan trọng của nghiên cứu.

---

Эксперимент (от лат. еxpеrimеntum – проба, опыт, чувственнопредметная деятельность в науке; в более узком смысле – опыт, воспроизведение объекта познания, проверка гипотез и т.п.) – это метод научного познания, при котором происходит исследование объекта в точно учитываемых условиях, задаваемых экспериментатором, позволяющий следить за изучаемым объектом и управлять им. Эксперимент, как и наблюдение, может быть качественным (обычно на ранних стадиях наблюдения) и количественным. 

Thí nghiệm (từ tiếng Latinh thí nghiệm - kiểm tra, trải nghiệm, hoạt động khách quan - giác quan trong khoa học; theo nghĩa hẹp hơn - trải nghiệm, tái tạo đối tượng tri thức, kiểm tra giả thuyết, v.v.) là một phương pháp tri thức khoa học trong đó đối tượng được được nghiên cứu trong các điều kiện được tính đến một cách chính xác, do người thí nghiệm đặt ra, cho phép bạn theo dõi và kiểm soát đối tượng đang được nghiên cứu. Một thí nghiệm, giống như một quan sát, có thể mang tính chất định tính (thường ở giai đoạn đầu của quá trình quan sát) và định lượng.

---

Преимущество экспериментального изучения объекта по сравнению с простым наблюдением заключается в следующем:  – возможность изучения свойств объекта в экстремальных условиях, что позволяет глубже проникнуть в сущность явлений (например, при разрушении объекта, при потере устойчивости элементов стержневых систем, при высоких и низких температурных воздействиях и т.п.);  – при необходимости многократное воспроизводство исследуемого явления; – изучение свойств явлений, не существующих в природе в чистом виде; – эксперимент можно повторить, а наблюдение не всегда.  

Ưu điểm của việc nghiên cứu thực nghiệm một vật thể so với quan sát đơn giản là: – khả năng nghiên cứu các tính chất của vật thể trong những điều kiện khắc nghiệt, cho phép người ta thâm nhập sâu hơn vào bản chất của hiện tượng (ví dụ, trong quá trình phá hủy một vật thể, khi các phần tử của hệ thống thanh mất đi sự ổn định, dưới ảnh hưởng của nhiệt độ cao và thấp, v.v.); - nếu cần thiết, lặp lại hiện tượng đang nghiên cứu; – nghiên cứu các tính chất của các hiện tượng không tồn tại trong tự nhiên ở dạng thuần túy; – một thí nghiệm có thể được lặp lại, nhưng một quan sát không phải lúc nào cũng được lặp lại.

---

Эксперименты могут быть натуральными и модельными. Натуральный эксперимент изучает объекты в их естественном состоянии. 

Các thí nghiệm có thể là tự nhiên hoặc mô hình. Một thí nghiệm tự nhiên nghiên cứu các vật thể ở trạng thái tự nhiên của chúng.

---

Модельный модернизует объекты и позволяет изучить более широкий диапазон изменения объекта [8]. 

Mô hình mô hình hiện đại hóa các đối tượng và cho phép người ta nghiên cứu phạm vi thay đổi đối tượng rộng hơn [8].

---

Эксперимент обычно ставят на заключительных стадиях исследования. Он является критерием интенсивности теорий и гипотез, а во многих случаях и источником новых теоретических представлений. Игнорирование эксперимента может привести к ошибкам.  

Thí nghiệm thường được thực hiện ở giai đoạn cuối của nghiên cứu. Nó là tiêu chí đánh giá cường độ của các lý thuyết và giả thuyết, và trong nhiều trường hợp là nguồn gốc của các ý tưởng lý thuyết mới. Bỏ qua thí nghiệm có thể dẫn đến sai sót.

---

Процесс подготовки и проведения экспериментального исследования обычно включает в себя несколько последовательных стадий (рис. 1.6). 

Quá trình chuẩn bị và tiến hành một nghiên cứu thực nghiệm thường bao gồm nhiều giai đoạn kế tiếp nhau (Hình 1.6).

---

Оптимизация процесса экспериментального исследования и управление научным поиском осуществляется на основе математической теории эксперимента, что способствует экономии времени и сокращению материальных затрат. 

Việc tối ưu hóa quy trình nghiên cứu thực nghiệm và quản lý nghiên cứu khoa học được thực hiện trên cơ sở lý thuyết toán học thực nghiệm giúp tiết kiệm thời gian, giảm chi phí vật chất.

---

Измерение – это процедура определения численного значения характеристик исследуемых материальных объектов (массы, скорости, температуры и т.д.). Все измерения производятся с помощью соответствующих измерительных приборов и сводятся к сравнению измеряемой величины с некоторой однородной величиной, принятой в качестве эталона.  

Đo lường là một thủ tục để xác định giá trị bằng số của các đặc tính của vật thể được nghiên cứu (khối lượng, tốc độ, nhiệt độ, v.v.). Tất cả các phép đo được thực hiện bằng các dụng cụ đo thích hợp và được giảm xuống mức so sánh giá trị đo được với một số giá trị đồng nhất được chấp nhận làm tiêu chuẩn.

---

В результате высококачественных измерений можно установить факты или определить эмпирические зависимости, сделать эмпирические открытия, приводящие к коренному изменению взглядов в какой-либо области знаний.

Nhờ các phép đo chất lượng cao, có thể thiết lập các sự kiện hoặc xác định các mối quan hệ thực nghiệm, đưa ra những khám phá thực nghiệm dẫn đến sự thay đổi cơ bản về quan điểm trong bất kỳ lĩnh vực kiến ​​thức nào.

```{figure} 1-6.png
```

Абсолютно точным измерение не может быть, поэтому большое внимание уделяется определению погрешности измерения (при измерениях стремятся определить погрешность и уменьшить ее). 

Một phép đo không thể chính xác tuyệt đối nên người ta phải chú ý nhiều đến việc xác định sai số của phép đo (trong quá trình đo, người ta cố gắng xác định sai số và giảm thiểu sai số đó).

---

В каждой конкретной науке, кроме рассмотренных выше методов научного познания, существуют и свои, присущие только данной науке специальные методы (физические, математические, биологические методы и т.д.). Специальные методы исследования в результате взаимо-проникновения различных наук находят применение и в других науках (например, математические методы в медицине, физиологии и т.п.).  Математические методы являются наиболее распространенными. 

Trong mỗi ngành khoa học cụ thể, ngoài các phương pháp tìm hiểu kiến ​​thức khoa học đã thảo luận ở trên, còn có những phương pháp đặc biệt chỉ có ở ngành khoa học này (phương pháp vật lý, toán học, sinh học, v.v.). Các phương pháp nghiên cứu đặc biệt do sự thâm nhập của nhiều ngành khoa học khác nhau được sử dụng trong các ngành khoa học khác (ví dụ, phương pháp toán học trong y học, sinh lý học, v.v.). Phương pháp toán học là phổ biến nhất.

---

Они широко используются в строительных науках. Примером могут служить матричные методы в строительной механике, применяемые при расчете статически неопределимых стержневых систем (метод сил, метод перемещений, смешанный метод, метод конечных элементов и др.). 

Chúng được sử dụng rộng rãi trong khoa học xây dựng. Một ví dụ là các phương pháp ma trận trong cơ học kết cấu, được sử dụng trong tính toán các hệ thanh bất định tĩnh (phương pháp lực, phương pháp chuyển vị, phương pháp hỗn hợp, phương pháp phần tử hữu hạn, v.v.).

---

Выбор того или иного метода научного познания при проведении конкретного исследования обусловлен спецификой изучаемого объекта [3]. 

Việc lựa chọn phương pháp này hay phương pháp tri thức khoa học khác khi tiến hành một nghiên cứu cụ thể được xác định bởi đặc thù của đối tượng được nghiên cứu [3].

## 1.6. Этические и эстетические основания методологии 

Эстетические основания. В любом виде деятельности человека в той или иной мере присутствуют эстетические компоненты. Их специфика и функции заключаются в том, что они являются сферой свободного самовыражения субъекта в его отношении к миру.  

Lý do thẩm mỹ. Trong bất kỳ loại hoạt động nào của con người, các thành phần thẩm mỹ đều hiện diện ở mức độ này hay mức độ khác. Tính đặc thù và chức năng của chúng nằm ở chỗ chúng là phạm vi tự do thể hiện của chủ thể trong mối quan hệ của anh ta với thế giới.

---

Эстетическая деятельность имеет предметно-духовный характер. Ее предметом может стать любой объект действительности, доступный непосредственному восприятию или представлению. Это могут быть художественные произведения, содержащие специально заложенную в них эстетическую информацию; природные явления, выделенные из естественного ряда благодаря тому, что к их упорядочению был причастен человека.  

Hoạt động thẩm mỹ có tính chất khách quan - tinh thần. Chủ thể của nó có thể là bất kỳ đối tượng nào của thực tại mà có thể tiếp cận được bằng nhận thức hoặc biểu đạt trực tiếp. Đây có thể là những tác phẩm nghệ thuật chứa thông tin thẩm mỹ được gắn riêng trong đó; hiện tượng tự nhiên tách biệt khỏi chuỗi tự nhiên do thực tế là con người có liên quan đến trật tự của chúng.

---

Предметом эстетической деятельности могут стать явления эстетически нейтральные, ценность которых актуализируется или утверждается в процессе самой деятельности. Мир человека всегда был и остается сферой особого интереса эстетической деятельности: общественноисторический процесс, общественная жизнь людей, их поведение и внутренний, духовный мир.  

Chủ thể của hoạt động thẩm mỹ có thể là những hiện tượng trung lập về mặt thẩm mỹ, giá trị của nó được hiện thực hóa hoặc khẳng định trong chính quá trình hoạt động đó. Thế giới con người luôn và vẫn là lĩnh vực được quan tâm đặc biệt đối với hoạt động thẩm mỹ: quá trình lịch sử - xã hội, đời sống xã hội của con người, hành vi của họ và thế giới nội tâm, tinh thần.

---

Эстетическое начало в труде имеет особое значение, являясь основной формой деятельности людей. Хорошо организованный, чередующийся с отдыхом свободный труд становится основной формой развития творческих, духовных и физических сил человека. С эстетическим началом в труде связано превращение его в первую жизненную потребность. 

Nguyên tắc thẩm mỹ trong lao động có tầm quan trọng đặc biệt, là hình thức hoạt động chủ yếu của con người. Lao động tự do được tổ chức tốt, xen kẽ với nghỉ ngơi, trở thành hình thức phát triển chính sức mạnh sáng tạo, tinh thần và thể chất của con người. Nguyên tắc thẩm mỹ trong lao động gắn liền với việc biến nó thành nhu cầu thiết yếu đầu tiên.

---

Труд, направленный на удовлетворение материальных и духовных потребностей, должен превращаться в потребность, свободное удовлетворение которой доставляло бы человеку наслаждение, подобное тому, какое испытывает художник, создавая произведение искусства.  

Lao động nhằm thỏa mãn nhu cầu vật chất và tinh thần phải chuyển thành nhu cầu, sự thỏa mãn tự do sẽ mang lại cho con người niềm vui, tương tự như trải nghiệm của một nghệ sĩ khi tạo ra một tác phẩm nghệ thuật.

---

Эстетические компоненты в научной деятельности играют существенную роль. Настоящему ученому занятия наукой доставляют огромное эстетическое наслаждение, не меньшее, чем деятельность художника или артиста. Но в результатах научной и художественной деятельности есть существенное принципиальное отличие. В искусстве художественные произведения сугубо персонифицированы. Каждое произведение неотъемлемо от автора, создавшего его. Если бы А.С. Пушкин не написал «Евгений Онегин» или Л.В. Бетховен не сочинил бы знаменитую Девятую симфонию, то этих произведений просто бы не существовало. В науке же положение несколько иное. Научные результаты тоже персонифицированы – каждая научная книга или статья имеет автора. 

Các thành phần thẩm mỹ đóng một vai trò quan trọng trong hoạt động khoa học. Đối với một nhà khoa học chân chính, làm khoa học mang lại niềm vui thẩm mỹ lớn lao không kém gì hoạt động của một nghệ sĩ, một nghệ sĩ biểu diễn. Nhưng có sự khác biệt cơ bản đáng kể về kết quả của hoạt động khoa học và nghệ thuật. Trong nghệ thuật, tác phẩm nghệ thuật hoàn toàn được nhân cách hóa. Mỗi tác phẩm không thể tách rời khỏi tác giả đã tạo ra nó. Nếu A.S. Pushkin không viết “Eugene Onegin” hay L.V. Nếu Beethoven không sáng tác Bản giao hưởng số 9 nổi tiếng thì những tác phẩm này sẽ không tồn tại. Trong khoa học, tình hình có phần khác. Kết quả khoa học cũng được cá nhân hóa - mỗi cuốn sách hoặc bài báo khoa học đều có tác giả.

---

Довольно часто научным законам, теориям, принципам присваиваются имена ученых. В то же время понятно, что если бы не было, например, И. Ньютона, Ч. Дарвина, А. Эйнштейна, Н.И. Лобачевского, то теории, которые мы связываем с их именами, скорее всего были бы созданы какими-то другими учеными. Они появились бы потому, что представляли собой объективно необходимые этапы развития науки. Об этом свидетельствуют многочисленные факты из истории развития науки, когда к одним и тем же идеям в самых различных отраслях приходили независимо друг от друга разные ученые.  

Khá thường xuyên, các định luật, lý thuyết và nguyên tắc khoa học đều được đặt theo tên của các nhà khoa học. Đồng thời, rõ ràng là nếu không có I. Newton, C. Darwin, A. Einstein, N.I. Lobachevsky, thì những lý thuyết mà chúng ta gắn với tên của họ rất có thể đã được tạo ra bởi một số nhà khoa học khác. Chúng xuất hiện vì chúng đại diện cho những giai đoạn cần thiết một cách khách quan trong quá trình phát triển của khoa học. Điều này được chứng minh bằng nhiều sự thật từ lịch sử phát triển của khoa học, khi các nhà khoa học khác nhau đi đến cùng một ý tưởng trong nhiều lĩnh vực độc lập với nhau.

---

Различие науки и искусства, как правило, объясняется тем, что наука дает логически аргументированное, понятийное, свободное от личных пристрастий знание, а искусство – наглядно, эмоционально, чувственно. Но иногда в научных спорах среди людей науки эмоции бывают столь же сильны, как и среди художников.  

Sự khác biệt giữa khoa học và nghệ thuật, như một quy luật, được giải thích bởi thực tế là khoa học cung cấp kiến ​​​​thức hợp lý, mang tính khái niệm, không thiên vị cá nhân và nghệ thuật cung cấp kiến ​​​​thức về thị giác, cảm xúc, cảm giác. Nhưng đôi khi trong những tranh chấp khoa học giữa những người làm khoa học, cảm xúc cũng mạnh mẽ như giữa các nghệ sĩ.

---

Различие места эмоций в процессах художественного и научного поиска, а также в восприятии художественных произведений и результатов научного труда состоит в том, что в науке эмоциональный момент не учитывается, хотя он и присутствует фактически. Здесь источником эмоций является реальная личность исследователя; но поскольку изложение итога и конечного результата исследования ведется как бы «от лица» абстрактного субъекта науки, то эмоции либо устраняются, либо не должны рассматриваться как собственный значимый компонент научного труда.  

Sự khác biệt về vị trí của cảm xúc trong quá trình tìm kiếm nghệ thuật và khoa học, cũng như trong nhận thức về tác phẩm nghệ thuật và kết quả của công việc khoa học, là trong khoa học, khoảnh khắc cảm xúc không được tính đến, mặc dù nó thực sự hiện diện. . Ở đây nguồn gốc của cảm xúc là nhân cách thực sự của người nghiên cứu; nhưng vì việc trình bày kết quả và kết quả cuối cùng của nghiên cứu được thực hiện như thể “thay mặt” cho chủ đề trừu tượng của khoa học, nên cảm xúc sẽ bị loại bỏ hoặc không nên được coi là một thành phần quan trọng của công việc khoa học.

---

В искусстве эмоционален не только сам художник, но и сопереживающий ему зритель, читатель, слушатель; эмоциональный момент является характеристикой субъекта искусства вообще. Искусство это личностное отражение действительности, а наука её отстраненно-объективное отражение.  

Trong nghệ thuật, không chỉ bản thân người nghệ sĩ giàu cảm xúc mà cả người xem, người đọc, người nghe cũng đồng cảm với mình; khoảnh khắc cảm xúc là một đặc điểm của chủ thể nghệ thuật nói chung. Nghệ thuật là sự phản ánh cá nhân về hiện thực, còn khoa học là sự phản ánh khách quan, khách quan của nó.

---

Таким образом, эстетика имеет непосредственное отношение к методологии науки как учения об организации научной деятельности, являясь одним из ее оснований.  

Như vậy, thẩm mỹ liên quan trực tiếp đến phương pháp luận của khoa học với tư cách là một học thuyết về tổ chức hoạt động khoa học, là một trong những nền tảng của nó.

---

Этические основания методологии. Поскольку любая человеческая деятельность осуществляется в обществе, то она основывается (точнее, должна всегда основываться) на морали и организовывается в соответствии с нравственными нормами. 

Cơ sở đạo đức của phương pháp. Vì bất kỳ hoạt động nào của con người được thực hiện trong xã hội nên nó đều dựa trên (hay nói đúng hơn là luôn phải dựa trên) đạo đức và được tổ chức theo các chuẩn mực đạo đức.

---

Нравственная культура общества характеризуется уровнем освоения членами общества нравственных норм, принципов, моральных требований, идеалов и т.д. Нравственность представляет собой единое целое, включающее моральное сознание, нравственные отношения и моральную деятельность. Природа морали социальна, она всегда имеет конкретно-историческое основание, обусловленное определенными общественными отношениями. Нравственная культура выступает как ценностное освоение человеком окружающего мира.  

Văn hóa đạo đức của một xã hội được đặc trưng bởi mức độ làm chủ của các thành viên trong xã hội về những chuẩn mực đạo đức, nguyên tắc, yêu cầu đạo đức, lý tưởng, v.v.. Đạo đức là một tổng thể duy nhất, bao gồm ý thức đạo đức, thái độ đạo đức và hoạt động đạo đức. Bản chất của đạo đức là xã hội; nó luôn có cơ sở lịch sử cụ thể, được quy định bởi những quan hệ xã hội nhất định. Văn hóa đạo đức đóng vai trò là sự phát triển dựa trên giá trị của một người đối với thế giới xung quanh.

---

Моральные ценности являются своеобразным регулятором отношений общества и личности, они пронизывают всю деятельность человека, всю систему взаимодействия между людьми. Такие категории морали, как добро, долг, честь, совесть, в этих ценностях получают конкретное выражение. Моральные ценности должны стать эталонами должного поведения. Они, как образец поведения, составляют основу моральных оценок деятельности масс, групп и индивидов, фактов и событий. И в случае возникновения актов отклоняющегося поведения посредством моральной оценки господствующее общественное мнение нацеливает индивидов, группы на образцы должного поведения.  

Giá trị đạo đức là một loại điều chỉnh các mối quan hệ giữa xã hội và cá nhân; chúng thấm sâu vào mọi hoạt động của con người, toàn bộ hệ thống tương tác giữa con người với nhau. Những phạm trù đạo đức như lòng tốt, bổn phận, danh dự, lương tâm được thể hiện cụ thể trong những giá trị này. Giá trị đạo đức phải trở thành tiêu chuẩn của hành vi đúng đắn. Chúng, với tư cách là một khuôn mẫu hành vi, tạo thành cơ sở đánh giá đạo đức đối với hoạt động của quần chúng, nhóm và cá nhân, sự kiện và sự kiện. Và trong trường hợp có hành vi lệch lạc, thông qua đánh giá đạo đức, dư luận chiếm ưu thế sẽ hướng tới các cá nhân, tập thể những tấm gương về hành vi đúng đắn.

---

Моральные установки общества и личности различны. Мораль общества не может быть сведена к механической сумме моральных установок индивидов, и индивидуальная мораль не тождественна общественной морали. Между должным поведением, отвечающим нравственным требованиям общества, и практической нравственностью, поступками людей, отражающими достигнутый уровень их морального развития, существуют отношения противоречивого единства, которые могут выражаться в нравственных коллизиях.  

Thái độ đạo đức của xã hội và cá nhân là khác nhau. Đạo đức của xã hội không thể bị quy giản thành một tổng thể máy móc của các thái độ đạo đức của các cá nhân, và đạo đức cá nhân không đồng nhất với đạo đức công cộng. Giữa hành vi đúng đắn, đáp ứng yêu cầu đạo đức của xã hội và đạo đức thực tiễn, hành động của con người phản ánh mức độ phát triển đạo đức đã đạt được của mình, tồn tại những mối quan hệ thống nhất trái ngược nhau, thể hiện ở những xung đột đạo đức.

---

Структурными эталонами нравственной культуры как целостной системы являются: – культура этического мышления (умение пользоваться этическим знанием, применять нравственные нормы к особенностям той или иной жизненной ситуации и т.д.); – культура поведения (умение строить свое поведение, совершать поступки соответственно усвоенным принципам и нормам морали); – культура чувств; – этикет, регламентирующий форму и манеру поведения. 

Các tiêu chuẩn cấu trúc của văn hóa đạo đức như một hệ thống không thể thiếu là: – văn hóa tư duy đạo đức (khả năng sử dụng kiến ​​thức đạo đức, áp dụng các tiêu chuẩn đạo đức vào đặc điểm của một hoàn cảnh sống cụ thể, v.v.); – văn hóa hành vi (khả năng cấu trúc hành vi của một người và thực hiện hành động phù hợp với các nguyên tắc và chuẩn mực đạo đức đã học); – văn hóa cảm xúc; - Nghi thức quy định hình thức và cách thức ứng xử.

---

Таким образом, нравственная культура является существенной стороной деятельности каждого человека, народа, класса, социальной группы, коллектива, отражая функционирование исторически-конкретной системы моральных ценностей.  

Như vậy, văn hóa đạo đức là một mặt tất yếu trong hoạt động của mỗi con người, mỗi dân tộc, giai cấp, nhóm xã hội, tập thể, phản ánh sự vận hành của một hệ thống giá trị đạo đức đặc thù lịch sử.

---

Нравственная культура общества по объему содержания более целостно охватывает утвердившуюся систему моральных ценностей и ориентаций, чем нравственная культура личности, в которой компоненты этой системы проявляются с неповторимой индивидуальной спецификой. Личность в индивидуальном преломлении аккумулирует в своем сознании и поведении достижения нравственной культуры общества. Это помогает человеку поступать нравственно в часто повторяющихся, нестандартных ситуациях и активизирует творческие элементы нравственного сознания.  

Văn hóa đạo đức của xã hội, về mặt nội dung, bao hàm một cách toàn diện hệ thống giá trị, định hướng đạo đức đã được thiết lập hơn là văn hóa đạo đức của cá nhân, trong đó các thành phần của hệ thống này được thể hiện với những đặc thù riêng của từng cá nhân. Một người, trong khúc xạ cá nhân, tích lũy trong ý thức và hành vi của mình những thành tựu của văn hóa đạo đức của xã hội. Điều này giúp một người hành động có đạo đức trong những tình huống không chuẩn mực, thường xuyên tái diễn và kích hoạt các yếu tố sáng tạo của ý thức đạo đức.
...
Hai cấp độ văn hóa đạo đức này có mối quan hệ chặt chẽ với nhau. Trình độ phát triển văn hóa đạo đức của xã hội phần lớn được quyết định bởi sự hoàn thiện văn hóa đạo đức của cá nhân. Mặt khác, văn hóa đạo đức của một xã hội càng phong phú thì cơ hội nâng cao văn hóa đạo đức của mỗi cá nhân càng mở ra.

---

Существует еще два специфических аспекта этики: «корпоративная» и профессиональная этика.  

Có hai khía cạnh cụ thể hơn của đạo đức: “đạo đức doanh nghiệp” và đạo đức nghề nghiệp.

---

Корпоративная этика – свод писаных и неписаных норм взаимоотношений между сотрудниками в рамках одного конкретного предприятия, фирмы, организации, учреждения либо сложившихся как традиции, либо закрепленных в нормативных документах – уставах, должностных инструкциях и, естественно, каждый руководитель, каждый сотрудник должны следовать этим внутренним нормам. 

Đạo đức doanh nghiệp là một tập hợp các chuẩn mực bằng văn bản và bất thành văn về mối quan hệ giữa các nhân viên trong một doanh nghiệp, công ty, tổ chức, cơ quan cụ thể, được thiết lập như truyền thống hoặc được ghi trong các văn bản quy định - điều lệ, bản mô tả công việc và tất nhiên, mọi người quản lý, mọi nhân viên đều phải tuân theo. những tiêu chuẩn nội bộ này
...
Đạo đức nghề nghiệp. Đối với một số ngành nghề, ngoài những chuẩn mực đạo đức phổ quát, quốc gia còn có thêm những chuẩn mực đạo đức nghề nghiệp bổ sung: y đức (Lời thề Hippocrates nổi tiếng), đạo đức sư phạm... Các hoạt động trong các ngành nghề như vậy được tổ chức theo các tiêu chuẩn đạo đức cụ thể này.

---

Нормы этики в профессиональной научной деятельности, т.е. нормы научной этики это отдельный вопрос. 

Các tiêu chuẩn đạo đức trong hoạt động khoa học chuyên nghiệp, tức là Các chuẩn mực đạo đức khoa học là một vấn đề riêng biệt.

---

Нормы научной этики. Нормы научной этики не сформулированы в виде каких-либо утвержденных кодексов, официальных требований. Но они существуют и могут рассматриваться в двух аспектах: внутренние (в сообществе ученых) этические нормы и внешние – как социальная ответственность ученых за свои действия и их последствия.  

Những chuẩn mực đạo đức khoa học. Các chuẩn mực về đạo đức khoa học không được xây dựng dưới dạng bất kỳ quy tắc hoặc yêu cầu chính thức nào được phê duyệt. Nhưng chúng tồn tại và có thể được xem xét ở hai khía cạnh: tiêu chuẩn đạo đức bên trong (trong cộng đồng các nhà khoa học) và bên ngoài - như trách nhiệm xã hội của các nhà khoa học đối với hành động và hậu quả của họ.

---

В 1942 году этические нормы научного сообщества были описаны Р. Мертоном (выдающийся социолог ХХ столетия, основатель социологии). По его мнению, науки – это совокупность четырех основных ценностей: – универсализм, т.е. истинность научных утверждений, должен оцениваться независимо от расы, пола, возраста, авторитета, званий тех, кто их формулирует. Наука изначально демократична: результаты крупного, известного ученого должны подвергаться строгой проверке и критике, как и результаты начинающего исследователя; – общность: научное знание должно свободно становиться общим достоянием; – незаинтересованность, беспристрастность: ученый должен искать истину бескорыстно. Нельзя рассматривать вознаграждение и признание научных достижений ученого как самоцель. Но существует и научная конкуренция, заключающаяся в стремлении ученых получить научный результат быстрее других, и конкуренция отдельных ученых, их коллективов за получение грантов, государственных заказов; – рациональный скептицизм: каждый исследователь несет ответственность за оценку качества того, что сделано его коллегами, он не освобождается от ответственности за использование в своей работе данных, полученных другими исследователями, если он сам не проверил точность этих данных. Другими словами, в науке необходимо, с одной стороны, уважение к тому, что сделали предшественники, а с другой стороны – скептическое отношение к их результатам: «Платон мне друг, но истина дороже» (Аристотель). 

Năm 1942, các chuẩn mực đạo đức của cộng đồng khoa học được mô tả bởi R. Merton (một nhà xã hội học kiệt xuất của thế kỷ XX, người sáng lập xã hội học). Theo ông, khoa học là sự kết hợp của bốn giá trị cơ bản: – tính phổ quát, tức là tính phổ quát. tính xác thực của các tuyên bố khoa học phải được đánh giá bất kể chủng tộc, giới tính, tuổi tác, thẩm quyền và chức danh của những người đưa ra chúng. Khoa học vốn mang tính dân chủ: kết quả của một nhà khoa học lớn, nổi tiếng phải được kiểm chứng và phê bình nghiêm ngặt, giống như kết quả của một nhà nghiên cứu mới vào nghề; – cộng đồng: kiến ​​thức khoa học phải trở thành tài sản chung một cách tự do; – vô tư, vô tư: nhà khoa học phải tìm kiếm sự thật một cách vị tha. Việc trả thù lao và công nhận thành tựu khoa học của một nhà khoa học tự nó không thể được coi là mục đích cuối cùng. Nhưng cũng có sự cạnh tranh khoa học, bao gồm mong muốn của các nhà khoa học đạt được kết quả khoa học nhanh hơn những người khác, và sự cạnh tranh giữa các cá nhân nhà khoa học và nhóm của họ để nhận được tài trợ và mệnh lệnh của chính phủ; – chủ nghĩa hoài nghi hợp lý: mỗi nhà nghiên cứu có trách nhiệm đánh giá chất lượng công việc mà đồng nghiệp của mình đã làm, anh ta không được miễn trách nhiệm sử dụng dữ liệu do các nhà nghiên cứu khác thu được vào công việc của mình, trừ khi chính anh ta đã xác minh tính chính xác của dữ liệu này. Nói cách khác, trong khoa học, một mặt cần phải tôn trọng những gì người đi trước đã làm, mặt khác cần có thái độ hoài nghi đối với kết quả của họ: “Plato là bạn của tôi, nhưng sự thật còn quý giá hơn” (Aristotle).

---

Внешняя этика науки в отличие от профессиональной, внутренней этики реализуется в отношениях науки и общества как социальная ответственность ученых. Эта проблема не стояла перед учеными до середины ХХ века – до появления ракетно-ядерного оружия, генной инженерии, гигантских экологических катастроф и других явлений, сопровождающих научно-технический прогресс. Сегодня ответственность ученого за последствия своих действий все возрастает и возрастает [1, 31].  

Đạo đức khoa học bên ngoài, trái ngược với đạo đức nghề nghiệp, đạo đức nội tại, được thể hiện trong mối quan hệ giữa khoa học và xã hội với tư cách là trách nhiệm xã hội của nhà khoa học. Vấn đề này đã không khiến các nhà khoa học phải đối mặt cho đến giữa thế kỷ 20 - trước khi có sự ra đời của tên lửa hạt nhân, kỹ thuật di truyền, những thảm họa môi trường khổng lồ và các hiện tượng khác đi kèm với tiến bộ khoa học và công nghệ. Ngày nay, trách nhiệm của một nhà khoa học đối với hậu quả do hành động của mình gây ra ngày càng tăng [1, 31].
...
9. Перечислить основные структурные элементы познания. 
10. В чем заключаются этические основания методологии? 

Câu hỏi để tự kiểm soát

1. Phương pháp luận là gì?
2. Hoạt động sinh sản và sản xuất của con người là gì?
3. Khái niệm “tổ chức” có nghĩa là gì?
4. Khoa học là gì và nó có đặc điểm gì?
5. Liệt kê các chức năng của khoa học.
6. Hãy kể cho chúng tôi nghe về các giai đoạn phát triển của khoa học.
7. Kiến thức là gì? Các loại kiến ​​thức.
8. Sự khác biệt giữa kiến ​​thức giác quan và kiến ​​thức lý trí là gì?
9. Liệt kê các yếu tố cấu trúc chính của nhận thức.
10. Nền tảng đạo đức của phương pháp này là gì?